...
const MontrealCategoryPage = lazy(() => import("./pages/canada/MontrealCategoryPage"));
...
const GlutenFreeBordeauxBest = lazy(() => import("./pages/france/GlutenFreeBordeauxBest"));
const BordeauxCategoryPage = lazy(() => import("./pages/france/BordeauxCategoryPage"));
...
const GlutenFreeNiceBest = lazy(() => import("./pages/france/GlutenFreeNiceBest"));
...
const GlutenFreeJohannesburgBest = lazy(() => import("./pages/johannesburg/GlutenFreeJohannesburgBest"));
const GlutenFreeDurban = lazy(() => import("./pages/GlutenFreeDurban"));
const GlutenFreeDurbanBest = lazy(() => import("./pages/durban/GlutenFreeDurbanBest"));
const GlutenFreePretoria = lazy(() => import("./pages/GlutenFreePretoria"));
const GlutenFreePretoriaBest = lazy(() => import("./pages/pretoria/GlutenFreePretoriaBest"));
...
const GlutenFreeCapeTownBest = lazy(() => import("./pages/cape-town/GlutenFreeCapeTownBest"));
        ...
        <Sonner />
          <Suspense fallback={<PageLoader />}>
            ...
            <Routes>
              ...
              <Route path="/gluten-free/italy/florence/best" element={<ItalyBestPage citySlug="florence" />} />
