...
import { MapPin, Star, ArrowLeft, Phone, Clock, Globe, CheckCircle, Navigation, Heart, Award, Shield, Search, Plus, Filter, Trophy, BookOpen } from "lucide-react";
      ...
      >
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            Dedicated Gluten-Free Restaurants in Durban
          </h1>
      ...
      <main className="container mx-auto px-4 py-8">
          ...
          <Card className="bg-gradient-to-r from-amber-50 to-orange-50 border-amber-200">
            <CardContent className="p-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h2 className="text-xl font-semibold text-gray-900 mb-1">Best Gluten-Free Restaurants in Durban</h2>
                  <p className="text-gray-700">Our editorial top 10 celiac-safe picks across Durban — ranked by safety, reviews and quality.</p>
                </div>
              </div>
              <Link to="/gluten-free/south-africa/durban/best-gluten-free-restaurants-in-durban" className="md:flex-shrink-0">
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-2 gap-2">
            <Card 
              className="hover:shadow-sm transition-shadow border border-green-200 bg-gradient-to-r from-green-50 to-emerald-50"
            >
            ...
            <Card 
              className="hover:shadow-sm transition-shadow border border-orange-200 bg-gradient-to-r from-orange-50 to-red-50"
            >
              <CardContent className="p-2 flex items-center gap-2">
                <span className="text-lg">🌮</span>
                <div>
        ...
        {/* FAQ Section */}
        <section className="mb-12">
          <RelatedCities country="south-africa" currentCitySlug="durban" />
        </section>
