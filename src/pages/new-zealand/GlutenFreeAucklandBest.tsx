...
const top = [...auckland.restaurants]
  .sort((a, b) => (b.rating !== a.rating ? b.rating - a.rating : b.reviewCount - a.reviewCount))
  .slice(0, 10);

const pageTitle = "Best Gluten-Free Restaurants in Auckland (2026) | Top 10 Celiac-Safe Picks";
const description =
  "The 10 best gluten-free restaurants in Auckland for celiacs in 2026 — dedicated GF bakeries, cafés and restaurants ranked by safety, reviews and quality.";

const schemaJson = [
  {
    "@context": "https://schema.org",
    "@type": "ItemList",
    name: "Best Gluten-Free Restaurants in Auckland",
    description,
    url: "https://glutenfreeplace.org/gluten-free/new-zealand/auckland/best-gluten-free-restaurants-in-auckland",
...
const GlutenFreeAucklandBest = () => (
  <>
    <SEOHead
      title={pageTitle}
      description={description}
      canonical="/gluten-free/new-zealand/auckland/best-gluten-free-restaurants-in-auckland"
      schemaJson={schemaJson}
    />
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50">
      <header className="bg-white shadow-sm border-b">
        <div className="container mx-auto px-4 py-4">
          <Link to="/gluten-free/new-zealand/auckland" className="inline-flex items-center text-blue-700 hover:text-blue-800">
      ...
      <section className="relative text-white py-14 bg-gradient-to-r from-blue-700 to-blue-500">
        <div className="absolute inset-0 bg-black/30" />
        <div className="container mx-auto px-4 text-center relative z-10">
          <span className="text-5xl mb-4 block">🏆</span>
          <h1 className="text-3xl md:text-5xl font-bold mb-4">Best Gluten-Free Restaurants in Auckland</h1>
          <p className="text-lg md:text-xl text-white/90 max-w-3xl mx-auto">
            Our top 10 celiac-safe picks across Auckland — ranked by safety, reviews and quality (updated 2026).
          </p>
        </div>
      </section>
      ...
      <main className="container mx-auto px-4 py-8">
          ...
          <Card className="bg-gradient-to-r from-blue-50 to-orange-50 border-blue-200">
            <CardContent className="p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h2 className="text-xl font-semibold text-gray-900 mb-2">How we rank Auckland GF restaurants</h2>
        ...
        <section className="mb-12 text-center">
          <Link to="/gluten-free/new-zealand/auckland" className="text-blue-700 hover:text-blue-800 font-medium">
            ← See all gluten-free restaurants in Auckland
          </Link>
        </section>
      </main>
    </div>
...
export default GlutenFreeAucklandBest;
