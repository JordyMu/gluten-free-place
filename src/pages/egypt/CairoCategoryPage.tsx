...
import { restaurantsForCityPage } from "./GlutenFreeCairo";
...
const CATEGORIES: Record<CategoryKey, CategoryMeta> = {
  "street-food": {
    title: "Gluten-Free Street Food in Cairo",
    emoji: "🍢",
    description:
      "Discover gluten-free street food, market stalls and quick bites across Cairo. Safe celiac-friendly options on the go.",
    badgeLabel: (n) => `${n} Street Food Spots`,
    filter: (r) => r.venueType === "street-food",
    comingSoonText:
      "We're actively researching gluten-free street food and market options in Cairo. Check back soon or suggest a venue!",
    venueLabel: "Street Food Spot",
    defaultVenueType: "street-food",
  },
  bakeries: {
    title: "Gluten-Free Bakeries in Cairo",
    emoji: "🥐",
    description:
      "Cairo has wonderful gluten-free bakeries — fresh bread, pastries and cakes safe for celiacs.",
    badgeLabel: (n) => `${n} Bakeries`,
    filter: (r) => r.venueType === "bakery",
    comingSoonText:
      "We're curating the best dedicated gluten-free bakeries in Cairo. Check back soon!",
    venueLabel: "Bakery",
    defaultVenueType: "bakery",
  },
  "grocery-stores": {
    title: "Gluten-Free Grocery Stores in Cairo",
    emoji: "🛒",
    description:
      "Supermarkets, health food shops and specialty stores in Cairo stocking gluten-free ranges.",
    badgeLabel: (n) => `${n} Stores`,
    filter: (r) => r.venueType === "supermarket",
    comingSoonText:
      "We're mapping the best gluten-free grocery stores and supermarkets in Cairo. Check back soon!",
    venueLabel: "Grocery Store",
    defaultVenueType: "supermarket",
  },
  "gluten-free-products": {
    title: "Gluten-Free Products in Cairo",
    emoji: "🛍️",
    description:
      "Specialty gluten-free products available in Cairo — flours, pastas, snacks and pantry essentials.",
    badgeLabel: (n) => `${n} Product Spots`,
    filter: (r) => r.venueType === "gf-products",
    comingSoonText:
      "We're putting together our recommended gluten-free product list for Cairo. Check back soon!",
...
const CairoCategoryPage = ({ category }: Props) => {
  ...
  return (
    <>
      <SEOHead
        ...
        canonical={`/gluten-free/egypt/cairo/${category}`}
      />
        ...
        <main className="container mx-auto px-4 py-12">
          <div className="max-w-3xl mx-auto mb-8 bg-white border border-orange-200 rounded-lg p-6 flex flex-col sm:flex-row items-center justify-between gap-4 shadow-sm">
            <div>
              ...
              <p className="text-sm text-gray-600">Help the community — share your favorite {meta.emoji} place in Cairo.</p>
            </div>
            <AddRestaurantDialog city="cairo" venueLabel={meta.venueLabel} defaultVenueType={meta.defaultVenueType} triggerClassName="bg-gradient-to-r from-orange-500 to-red-500 text-white border-0 hover:from-orange-600 hover:to-red-600" />
          </div>
          ...
          {venues.length > 0 ? (
                  ...
                  <CardContent className="p-6">
                    <div className="mb-3">
                      <div className="flex items-center gap-2 mb-1 flex-wrap">
                        ...
                        <Link
                          to={`/gluten-free/egypt/cairo/${restaurant.slug}`}
            ...
            <Card className="text-center py-12 max-w-2xl mx-auto">
              <CardContent>
                ...
                <Link to="/gluten-free/egypt/cairo">
                  <Button className="mt-6">Browse All Cairo Venues</Button>
                </Link>
              </CardContent>
            </Card>
          )}
...
export default CairoCategoryPage;
