...
const rome = cities.find((c) => c.slug === "rome");
const top = rome
  ? [...rome.restaurants]
      .sort((a, b) => {
        const ra = a.rating ?? 0;
...
const pageTitle = "Best Gluten-Free Restaurants in Rome (2026) | Top 10 Celiac-Safe Picks";
const description =
  "The 10 best gluten-free restaurants in Rome for celiacs in 2026 — dedicated GF pizzerias, trattorias and bakeries ranked by safety, reviews and quality.";

const schemaJson = [
  {
    "@context": "https://schema.org",
    "@type": "ItemList",
    name: "Best Gluten-Free Restaurants in Rome",
    description,
    url: "https://glutenfreeplace.org/gluten-free/italy/rome/best",
    itemListElement: top.map((r, i) => ({
      "@type": "ListItem",
      position: i + 1,
      name: r.name,
      url: `https://glutenfreeplace.org/gluten-free/italy/rome/${slugify(r.name)}`,
    })),
  },
];

const GlutenFreeRomeBest = () => (
  <>
    <SEOHead
      title={pageTitle}
      description={description}
      canonical="/gluten-free/italy/rome/best"
      schemaJson={schemaJson}
    />
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-green-50">
      <header className="bg-white shadow-sm border-b">
        <div className="container mx-auto px-4 py-4">
          <Link to="/gluten-free/italy/rome" className="inline-flex items-center text-orange-600 hover:text-orange-700">
      ...
      >
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <h1 className="text-3xl md:text-5xl font-bold mb-4">Best Gluten-Free Restaurants in Rome</h1>
          <p className="text-lg md:text-xl text-white/90 max-w-3xl mx-auto">
            Our top 10 celiac-safe picks across Rome — ranked by safety, reviews and quality (updated 2026).
          </p>
        </div>
      </section>
      ...
      <main className="container mx-auto px-4 py-8">
          ...
          <Card className="bg-gradient-to-r from-orange-50 to-green-50 border-orange-200">
            <CardContent className="p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h2 className="text-xl font-semibold text-gray-900 mb-2">How we rank Rome GF restaurants</h2>
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Top 10 Gluten-Free Restaurants in Rome</h2>
                ...
                <Card key={rSlug} className="overflow-hidden">
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4 mb-3 flex-wrap">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1 flex-wrap">
                          ...
                          <Link
                            to={`/gluten-free/italy/rome/${rSlug}`}
                    ...
                    <div className="flex flex-wrap gap-3">
                      ...
                      <Link to={`/gluten-free/italy/rome/${rSlug}`}>
        ...
        <section className="mb-12 text-center">
          <Link to="/gluten-free/italy/rome" className="text-orange-600 hover:text-orange-700 font-medium">
            ← See all gluten-free restaurants in Rome
          </Link>
        </section>
      </main>
    </div>
...
export default GlutenFreeRomeBest;
