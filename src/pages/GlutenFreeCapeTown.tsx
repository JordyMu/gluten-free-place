...
const GlutenFreeCapeTown = () => {
  ...
  // Stellenbosch restaurants are now on their own dedicated page

  // Franschhoek restaurants are now on their own dedicated page
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <Link to="/gluten-free/south-africa/cape-town/franschhoek">
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-3 gap-2">
            ...
            <Link to="/gluten-free/south-africa/cape-town/bakeries">
              <Card className="cursor-pointer hover:shadow-sm transition-shadow border border-amber-200 bg-gradient-to-r from-amber-50 to-yellow-50">
                <CardContent className="p-2 flex items-center gap-2">
                  <span className="text-lg">🥐</span>
                  <div>
            ...
            <Link to="/gluten-free/south-africa/cape-town/grocery-stores">
                      ...
                      <div className="flex items-start justify-between mb-3">
                        <div>
                          <div className="flex items-center gap-2 mb-1 flex-wrap">
                            ...
                            <Link 
                              to={`/gluten-free/south-africa/cape-town/${restaurant.name.toLowerCase().replace(/[^a-z0-9]+/g, '-').replace(/(^-|-$)/g, '')}`}
        ...
        {/* Footer - Browse by Category */}
        <footer className="mt-12 pt-8 border-t border-gray-200">
          <div className="text-center mb-6">
            <h3 className="text-xl font-bold text-gray-900 mb-2">Browse Gluten-Free Options by Category</h3>
            <p className="text-gray-600">Find what you need in Cape Town</p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4">
            <Button
              variant="outline"
              className="flex flex-col items-center gap-2 h-auto py-4 hover:bg-rose-50 hover:border-rose-300"
            ...
            >
              <span className="text-2xl">🛒</span>
              <span className="text-sm font-medium">Supermarkets</span>
            </Button>
            <Button
              variant="outline"
              className="flex flex-col items-center gap-2 h-auto py-4 hover:bg-rose-50 hover:border-rose-300"
            ...
            >
              <span className="text-2xl">🍢</span>
              <span className="text-sm font-medium">Street Food</span>
            </Button>
            <Button
              variant="outline"
              className="flex flex-col items-center gap-2 h-auto py-4 hover:bg-rose-50 hover:border-rose-300"
              onClick={() => setVenueFilter("home-baker")}
            >
              <span className="text-2xl">🏠</span>
              <span className="text-sm font-medium">Home Bakers</span>
            </Button>
            <Button
              variant="outline"
              className="flex flex-col items-center gap-2 h-auto py-4 hover:bg-rose-50 hover:border-rose-300"
              onClick={() => setVenueFilter("gf-products")}
            >
              <span className="text-2xl">🛍️</span>
              <span className="text-sm font-medium">GF Products</span>
            </Button>
          </div>
