...
const otherLocations = [
  ...
  },
  {
    ...
    specialty: "Beachfront lodge restaurant with international buffet and made-to-order grilled dishes; gluten-free options available on request.",
    rating: 4.5,
    reviewCount: 112,
    cuisineTypes: ["Resort Dining", "International"],
    menuType: "mixed-menu",
  },
  {
    ...
    icon: "☕",
    location: "Luxor",
    specialty: "Riverside café serving fresh juices, salads and light meals with a relaxed Nile-view terrace and GF-friendly options.",
    rating: 4.6,
    reviewCount: 94,
    cuisineTypes: ["Café", "Mediterranean"],
    menuType: "mixed-menu",
  },
  {
    ...
    icon: "🌿",
    location: "Hurghada",
    specialty: "Garden-style health-food restaurant offering smoothie bowls, vegan plates and clearly labelled gluten-free dishes.",
    rating: 4.7,
    reviewCount: 156,
    cuisineTypes: ["Health Food", "International"],
    menuType: "mixed-menu",
  },
  {
    ...
    icon: "🏨",
    location: "Luxor",
    specialty: "Luxury resort dining with multiple restaurants, buffet labelling and allergen-aware staff for gluten-free guests.",
    rating: 4.6,
    reviewCount: 203,
    cuisineTypes: ["Resort Dining", "International"],
    menuType: "mixed-menu",
  },
  {
    ...
    icon: "🏨",
    location: "Hurghada",
    specialty: "Adults-only resort with themed restaurants and a dedicated gluten-free corner at the main buffet.",
    rating: 4.5,
    reviewCount: 178,
    cuisineTypes: ["Resort Dining", "International"],
    menuType: "mixed-menu",
  },
  {
    ...
    icon: "🏨",
    location: "El Gouna",
    specialty: "Red Sea resort with waterfront dining, fresh seafood and gluten-free options across its restaurants.",
    rating: 4.6,
    reviewCount: 165,
    cuisineTypes: ["Resort Dining", "Seafood"],
    menuType: "mixed-menu",
  },
  {
    name: "مطعم سنوبس Snobs Restaurant",
    icon: "🍽️",
    location: "Luxor",
    specialty: "Popular local eatery known for Egyptian and international comfort food with gluten-free adaptations on request.",
    rating: 4.4,
    reviewCount: 231,
    cuisineTypes: ["Egyptian", "International"],
    menuType: "mixed-menu",
  },
  {
    ...
    icon: "🏨",
    location: "Hurghada",
    specialty: "Five-star beach resort with all-inclusive dining, live cooking stations and allergen-labelled buffet choices.",
    rating: 4.7,
    reviewCount: 189,
    cuisineTypes: ["Resort Dining", "International"],
    menuType: "mixed-menu",
  },
  {
    ...
    icon: "🏨",
    location: "Aswan",
    specialty: "Iconic Nile-side hotel offering fine dining with gluten-free menus and panoramic views of Elephantine Island.",
    rating: 4.8,
    reviewCount: 267,
  ...
  },
  {
    ...
    icon: "🏨",
    location: "Safaga / Soma Bay",
    specialty: "Family-friendly resort with aquapark, buffet stations and gluten-free options available at main restaurants.",
    rating: 4.4,
    reviewCount: 134,
    cuisineTypes: ["Resort Dining", "International"],
    menuType: "mixed-menu",
  },
  {
    ...
    icon: "🏨",
    location: "Marsa Alam",
    specialty: "All-inclusive Red Sea resort with Italian-themed dining and gluten-free choices at buffet and à-la-carte venues.",
    rating: 4.5,
    reviewCount: 145,
    cuisineTypes: ["Resort Dining", "Italian"],
    menuType: "mixed-menu",
  },
  {
    ...
    icon: "🏨",
    location: "Hurghada",
    specialty: "Beachfront resort with multiple restaurants and a gluten-free corner in the main buffet area.",
    rating: 4.4,
    reviewCount: 198,
    cuisineTypes: ["Resort Dining", "International"],
    menuType: "mixed-menu",
  },
  {
    ...
    icon: "🥖",
    location: "El Gouna",
    specialty: "Bakery and café offering fresh breads, pastries and sandwiches with a selection of gluten-free baked goods.",
    rating: 4.7,
    reviewCount: 122,
    cuisineTypes: ["Bakery", "Café"],
    menuType: "mixed-menu",
  },
  {
    ...
    specialty: "Mountain café near Mount Sinai serving breakfast, coffee and simple gluten-free snacks for hikers.",
    rating: 4.5,
    reviewCount: 87,
  ...
  },
  {
    ...
    icon: "🛒",
    location: "Saint Catherine",
    specialty: "Small grocery and supply stop stocking gluten-free snacks, energy bars and essentials for trekkers.",
    rating: 4.3,
    reviewCount: 56,
    cuisineTypes: ["Grocery", "Snacks"],
    menuType: "mixed-menu",
  },
  {
    ...
    specialty: "Diving resort with beachfront restaurant, fresh seafood grills and gluten-free options by arrangement.",
    rating: 4.6,
    reviewCount: 142,
    cuisineTypes: ["Resort Dining", "Seafood"],
    menuType: "mixed-menu",
  },
  {
    ...
    icon: "🏨",
    location: "El Gouna",
    specialty: "Boutique adults-only hotel with street-food inspired dining and health-focused gluten-free choices.",
    rating: 4.5,
    reviewCount: 119,
    cuisineTypes: ["Resort Dining", "Street Food"],
    menuType: "mixed-menu",
  },
  {
    ...
    icon: "🏨",
    location: "Marsa Alam",
    specialty: "Beach resort with international buffet, live cooking and staff trained to handle gluten-free requests.",
    rating: 4.4,
    reviewCount: 98,
    cuisineTypes: ["Resort Dining", "International"],
    menuType: "mixed-menu",
  },
  {
    ...
    icon: "🏨",
    location: "El Gouna",
    specialty: "Family resort with multiple dining outlets and gluten-free options available at the main restaurant.",
    rating: 4.5,
    reviewCount: 111,
    cuisineTypes: ["Resort Dining", "International"],
    menuType: "mixed-menu",
  },
  {
    ...
    icon: "🏨",
    location: "Hurghada",
    specialty: "Large beach resort with extensive buffet choices, including a gluten-free section and made-to-order stations.",
    rating: 4.6,
    reviewCount: 176,
    cuisineTypes: ["Resort Dining", "International"],
    menuType: "mixed-menu",
  },
  {
    ...
    icon: "🏨",
    location: "Aswan",
    specialty: "Nile-view hotel with Mediterranean and Egyptian restaurants offering gluten-free dishes on request.",
    rating: 4.7,
    reviewCount: 154,
    cuisineTypes: ["Resort Dining", "Mediterranean"],
    menuType: "mixed-menu",
  },
  {
    name: "King Jamaica",
    icon: "🍽️",
    location: "Aswan",
    specialty: "Lively restaurant serving grilled meats, tagines and Egyptian staples with gluten-free options available.",
    rating: 4.4,
    reviewCount: 213,
  ...
  },
  {
    ...
    icon: "🍽️",
    location: "Luxor",
    specialty: "Long-running local restaurant offering Egyptian and continental dishes with coeliac-friendly options.",
    rating: 4.5,
    reviewCount: 187,
    cuisineTypes: ["Egyptian", "Continental"],
    menuType: "mixed-menu",
  },
  {
    ...
    icon: "🌻",
    location: "Luxor",
    specialty: "Vegetarian-friendly spot near the Nile with fresh salads, soups and gluten-free mains.",
    rating: 4.6,
    reviewCount: 164,
    cuisineTypes: ["Vegetarian", "International"],
    menuType: "mixed-menu",
  },
