...
export const spainRestaurants: SpainRestaurant[] = [
  {
    ...
    description:
      "100% gluten-free Neapolitan pizzeria with a dedicated kitchen. Celiacs can enjoy wood-fired pizzas, fresh pasta, and Italian desserts safely in Barcelona.",
  ...
  },
  {
    ...
    description:
      "100% gluten-free bakery in Gràcia offering artisanal Catalan breads, pastries, and cakes baked fresh daily in a dedicated facility.",
  ...
  },
  {
    ...
    description:
      "Artisanal chocolate bar in El Born with an extensive gluten-free selection. Staff clearly mark celiac-safe options and understand cross-contamination.",
  ...
  },
  {
    ...
    description:
      "Italian restaurant on Carrer de Muntaner with an extensive gluten-free menu. A reliable choice for celiac-safe pizzas, pastas, and Italian classics.",
  ...
  },
  {
    ...
    description:
      "Dedicated gluten-free pizzeria in Gràcia serving Neapolitan-style pizzas, pastas, and Italian desserts from a 100% gluten-free kitchen.",
  ...
  },
  {
    ...
    description:
      "Creative Asian-fusion restaurant in central Barcelona offering gluten-free bao, dumplings, ramen, and rice-based mains using tamari and GF ingredients.",
  ...
  },
  {
    ...
    description:
      "Elegant French restaurant in Raval offering a refined menu adapted for gluten-free diners, with careful cross-contamination protocols.",
  ...
  },
  {
    ...
    description:
      "Dedicated gluten-free bakery and brunch spot in Gràcia. Fresh pastries, breads, cakes, and a full brunch menu from a 100% GF kitchen.",
  ...
  },
  {
    ...
    description:
      "Health-focused pizzeria in Eixample specialising in nutritious, 100% gluten-free pizzas, salads, and vegetarian options in a casual space.",
  ...
  },
  {
    ...
    description:
      "Dedicated gluten-free obrador in Gràcia crafting artisanal breads, pastries, and savoury bakes entirely free from gluten, made fresh on-site.",
  ...
  },
  {
    ...
    description:
      "Bright, health-conscious brunch spot on Passeig de Sant Joan with a strong gluten-free focus, offering bowls, salads, toasts, and homemade cakes.",
  ...
  },
  {
    ...
    description:
      "Carrer de València branch of Grosso Napoletano serving certified 100% gluten-free Neapolitan pizza, pasta, and desserts from a dedicated kitchen.",
  ...
  },
  {
    ...
    description:
      "Original Chök chocolate kitchen in Ciutat Vella, famous for artisanal chocolates, kookies, and desserts with clearly labelled celiac-safe options.",
  ...
  },
  {
    ...
    address: "Av. de França, 55, Camins al Grau, 46023 València",
    hours: "Daily: 8:00 AM – 2:00 PM",
    phone: "+34 673 81 67 83",
  ...
  },
  {
    ...
    description:
      "Dedicated celiac bakery and café in Eixample offering fully gluten-free breads, pastries, sandwiches, and cakes in a controlled environment.",
  ...
  },
  {
    ...
    description:
      "Healthy gluten-free-friendly bistro on Via Laietana serving nourishing brunch plates, bowls, salads, and homemade cakes with celiac-safe options.",
