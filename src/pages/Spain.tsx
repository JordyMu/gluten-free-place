                ...
                <CardContent className="p-6">
                  ...
                  <div className="space-y-2 mb-4">
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <div className="flex items-center">
                        ...
                        <span className="font-semibold text-green-600">{restaurant.staffRating}</span>
                      </div>
                    </div>
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <div className="flex items-center">
                        <Star className="h-3 w-3 text-yellow-400 fill-current mr-1" />
                        <span className="font-semibold text-green-600">{restaurant.knowledgeRating}</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-2 mb-4 text-xs">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-green-600 font-medium">{restaurant.crossContamination}</span>
                    </div>
                  </div>
