    ...
    restaurants: [
      {
        ...
        website: "www.glutenfreebkk.com",
        phone: "+66 2 345 6789",
        directions: "https://maps.google.com/?q=Gluten+Free+Bangkok",
        overview: "Thailand's first 100% gluten-free Thai restaurant offering authentic flavors in a completely celiac-safe environment. All traditional Thai sauces are made gluten-free in-house.",
        menuHighlights: ["Pad Thai", "Green Curry", "Tom Yum Soup", "Mango Sticky Rice", "Spring Rolls"],
        reviews: [
          { author: "Maria S.", text: "Incredible authentic Thai food! Finally can enjoy Pad Thai without worrying.", rating: 5 },
          { author: "David K.", text: "The green curry is phenomenal and completely safe for celiacs.", rating: 5 }
        ],
        proTip: "All their curry pastes and fish sauces are made from scratch without gluten - ask for their secret recipe tips!"
      }
    ]
  }
];
      ...
      <header className="bg-white/80 backdrop-blur-md border-b sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Gluten-Free Restaurants in Thailand</h1>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center space-y-4">
            ...
            <p className="text-gray-600 leading-relaxed">
              Discover Thailand's best gluten-free dining options. From authentic Thai street food to refined cuisine,
              these certified celiac-safe restaurants bring you the bold flavors of Thailand without compromise.
            </p>
          </div>
        </div>
      </section>
