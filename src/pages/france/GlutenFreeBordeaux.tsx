      ...
      <>
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
            <Link to="/gluten-free/france/bordeaux/street-food">
            ...
            <Link to="/gluten-free/france/bordeaux/bakeries">
            ...
            <Link to="/gluten-free/france/bordeaux/grocery-stores">
            ...
            <Link to="/gluten-free/france/bordeaux/gluten-free-products">
          ...
          <Card className="bg-gradient-to-r from-amber-50 to-orange-50 border-amber-200">
            <CardContent className="p-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h2 className="text-xl font-semibold text-gray-900 mb-1">Best Gluten-Free Restaurants in Bordeaux</h2>
                  <p className="text-gray-700">Our editorial top picks across Bordeaux — ranked by safety, reviews and quality.</p>
                </div>
              </div>
              <Link to="/gluten-free/france/bordeaux/best" className="md:flex-shrink-0">
