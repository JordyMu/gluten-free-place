...
const pageTitle = "Best Gluten-Free Restaurants in Lyon (2026) | Top Celiac-Safe Picks";
const description =
  "The best gluten-free restaurants in Lyon for celiacs in 2026 — dedicated GF bakeries and celiac-safe spots ranked by safety, reviews and quality.";

const schemaJson = [
  {
    "@context": "https://schema.org",
    "@type": "ItemList",
    name: "Best Gluten-Free Restaurants in Lyon",
    description,
    url: "https://glutenfreeplace.org/gluten-free/france/lyon/best",
    itemListElement: top.map((r, i) => ({
      "@type": "ListItem",
      position: i + 1,
      name: r.name,
      url: `https://glutenfreeplace.org/gluten-free/france/lyon/${r.slug}`,
    })),
  },
];

const GlutenFreeLyonBest = () => (
  <>
    <SEOHead
      title={pageTitle}
      description={description}
      canonical="/gluten-free/france/lyon/best"
      schemaJson={schemaJson}
    />
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-red-50">
      <header className="bg-white shadow-sm border-b">
        <div className="container mx-auto px-4 py-4">
          <Link to="/gluten-free/france/lyon" className="inline-flex items-center text-blue-700 hover:text-blue-800">
      ...
      <section className="relative text-white py-14 bg-gradient-to-r from-blue-700 via-white/10 to-red-600">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <h1 className="text-3xl md:text-5xl font-bold mb-4">Best Gluten-Free Restaurants in Lyon</h1>
          <p className="text-lg md:text-xl text-white/90 max-w-3xl mx-auto">
            Our top celiac-safe picks across Lyon — ranked by safety, reviews and quality (updated 2026).
          </p>
        </div>
      </section>
      ...
      <main className="container mx-auto px-4 py-8">
          ...
          <Card className="bg-gradient-to-r from-blue-50 to-red-50 border-blue-200">
            <CardContent className="p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h2 className="text-xl font-semibold text-gray-900 mb-2">How we rank Lyon GF restaurants</h2>
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Top Gluten-Free Restaurants in Lyon</h2>
              ...
              <Card key={r.slug} className="overflow-hidden">
                <CardContent className="p-6">
                  <div className="flex items-start gap-4 mb-3 flex-wrap">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-1 flex-wrap">
                        ...
                        <Link
                          to={`/gluten-free/france/lyon/${r.slug}`}
                  ...
                  <div className="flex flex-wrap gap-3">
                    ...
                    <Link to={`/gluten-free/france/lyon/${r.slug}`}>
        ...
        <section className="mb-12 text-center">
          <Link to="/gluten-free/france/lyon" className="text-blue-700 hover:text-blue-800 font-medium">
            ← See all gluten-free restaurants in Lyon
          </Link>
        </section>
      </main>
    </div>
...
export default GlutenFreeLyonBest;
