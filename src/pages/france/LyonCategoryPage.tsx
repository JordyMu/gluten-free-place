...
const CATEGORIES: Record<CategoryKey, CategoryMeta> = {
  "street-food": {
    title: "Gluten-Free Street Food in Lyon",
    emoji: "🍢",
    description:
      "Discover gluten-free street food, food trucks and quick bites across Lyon. Safe celiac-friendly options on the go.",
    badgeLabel: (n) => `${n} Street Food Spots`,
    filter: (r) => r.venueType === "street-food",
    comingSoonText:
      "We're actively researching gluten-free street food and food-truck options in Lyon. Check back soon or suggest a venue!",
    venueLabel: "Street Food Spot",
    defaultVenueType: "street-food",
  },
  bakeries: {
    title: "Gluten-Free Bakeries in Lyon",
    emoji: "🥐",
    description:
      "Dedicated and celiac-friendly bakeries in Lyon offering safe croissants, baguettes, pastries and cakes.",
    ...
    comingSoonText:
      "We're curating the best dedicated gluten-free bakeries in Lyon. Check back soon!",
    venueLabel: "Bakery",
    defaultVenueType: "bakery",
  },
  "grocery-stores": {
    title: "Gluten-Free Grocery Stores in Lyon",
    emoji: "🛒",
    description:
      "Supermarkets, health food shops and specialty stores in Lyon stocking gluten-free ranges.",
    badgeLabel: (n) => `${n} Stores`,
    filter: (r) => r.venueType === "supermarket",
    comingSoonText:
      "We're mapping the best gluten-free grocery stores and supermarkets in Lyon. Check back soon!",
    venueLabel: "Grocery Store",
    defaultVenueType: "supermarket",
  },
  "gluten-free-products": {
    title: "Gluten-Free Products in Lyon",
    emoji: "🛍️",
    description:
      "Specialty gluten-free products available in Lyon — flours, pastas, snacks and pantry essentials.",
    badgeLabel: (n) => `${n} Product Spots`,
    filter: (r) => r.venueType === "gf-products",
    comingSoonText:
      "We're putting together our recommended gluten-free product list for Lyon. Check back soon!",
  ...
  return (
    <>
      <SEOHead
        ...
        canonical={`/gluten-free/france/lyon/${category}`}
      />
      <div className="min-h-screen bg-gradient-to-b from-orange-50 to-white">
        <header className="bg-white shadow-sm border-b">
          <div className="container mx-auto px-4 py-4">
            <Link to="/gluten-free/france/lyon">
        ...
        <main className="container mx-auto px-4 py-12">
          <div className="max-w-3xl mx-auto mb-8 bg-white border border-orange-200 rounded-lg p-6 flex flex-col sm:flex-row items-center justify-between gap-4 shadow-sm">
            <div>
              ...
              <p className="text-sm text-gray-600">Help the community — share your favorite {meta.emoji} place in Lyon.</p>
            </div>
            <AddRestaurantDialog city="lyon" venueLabel={meta.venueLabel} defaultVenueType={meta.defaultVenueType} triggerClassName="bg-gradient-to-r from-orange-500 to-red-500 text-white border-0 hover:from-orange-600 hover:to-red-600" />
          </div>
          ...
          {venues.length > 0 ? (
                  ...
                  <CardContent className="p-6">
                    <div className="mb-3">
                      <div className="flex items-center gap-2 mb-1 flex-wrap">
                        ...
                        <Link
                          to={`/gluten-free/france/lyon/${restaurant.slug}`}
            ...
            <Card className="text-center py-12 max-w-2xl mx-auto">
              <CardContent>
                ...
                <Link to="/gluten-free/france/lyon">
                  <Button className="mt-6">Browse All Lyon Venues</Button>
                </Link>
              </CardContent>
            </Card>
          )}
...
export default LyonCategoryPage;
