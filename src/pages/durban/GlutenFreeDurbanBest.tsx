...
const pageTitle = "Best Gluten-Free Restaurants in Durban (2026) | Top 10 Celiac-Safe Picks";
const description =
  "The 10 best gluten-free restaurants in Durban for celiacs in 2026 — fine dining, Indian, steakhouse and seafood ranked by safety, reviews and quality.";

const schemaJson = [
  {
    "@context": "https://schema.org",
    "@type": "ItemList",
    name: "Best Gluten-Free Restaurants in Durban",
    description,
    url: "https://glutenfreeplace.org/gluten-free/south-africa/durban/best-gluten-free-restaurants-in-durban",
    itemListElement: top.map((r, i) => ({
      "@type": "ListItem",
      position: i + 1,
      name: r.name,
      url: `https://glutenfreeplace.org/gluten-free/south-africa/durban/${r.slug}`,
    })),
  },
];

const GlutenFreeDurbanBest = () => (
  <>
    <SEOHead
      title={pageTitle}
      description={description}
      canonical="/gluten-free/south-africa/durban/best-gluten-free-restaurants-in-durban"
      schemaJson={schemaJson}
    />
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-cyan-50">
      <header className="bg-white shadow-sm border-b">
        <div className="container mx-auto px-4 py-4">
          <Link to="/gluten-free/south-africa/durban" className="inline-flex items-center text-blue-700 hover:text-blue-800">
      ...
      <section
        ...
        style={{ backgroundImage: "linear-gradient(to right, rgba(0,0,0,0.6), rgba(0,0,0,0.4)), url('/images/durban-hero.webp')" }}
      >
        <div className="absolute inset-0 bg-black/40" />
        <div className="container mx-auto px-4 text-center relative z-10">
          <span className="text-5xl mb-4 block">🏆</span>
          <h1 className="text-3xl md:text-5xl font-bold mb-4">Best Gluten-Free Restaurants in Durban</h1>
          <p className="text-lg md:text-xl text-white/90 max-w-3xl mx-auto">
            Our top 10 celiac-safe picks across Durban — ranked by safety, reviews and quality (updated 2026).
          </p>
        </div>
      </section>
      ...
      <main className="container mx-auto px-4 py-8">
          ...
          <Card className="bg-gradient-to-r from-blue-50 to-cyan-50 border-blue-200">
            <CardContent className="p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h2 className="text-xl font-semibold text-gray-900 mb-2">How we rank Durban GF restaurants</h2>
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Top 10 Gluten-Free Restaurants in Durban</h2>
              ...
              <Card key={r.slug} className="overflow-hidden">
                <CardContent className="p-6">
                  <div className="flex items-start gap-4 mb-3 flex-wrap">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-1 flex-wrap">
                        ...
                        <Link
                          to={`/gluten-free/south-africa/durban/${r.slug}`}
                  ...
                  <div className="flex flex-wrap gap-3">
                    ...
                    <Link to={`/gluten-free/south-africa/durban/${r.slug}`}>
        ...
        <section className="mb-12 text-center">
          <Link to="/gluten-free/south-africa/durban" className="text-blue-700 hover:text-blue-800 font-medium">
            ← See all gluten-free restaurants in Durban
          </Link>
        </section>
      </main>
    </div>
...
export default GlutenFreeDurbanBest;
