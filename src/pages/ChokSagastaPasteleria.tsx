  ...
  const reviews = [
    {
      ...
      rating: 5,
      date: "2 weeks ago",
      comment: "Amazing authentic Spanish pastries! As a celiac, I felt completely safe here. The gluten-free bread was incredible."
    },
    {
      id: 2,
      name: "Marco R.",
      rating: 5,
      date: "1 month ago",
      comment: "Best gluten-free pastry shop in Madrid! Staff is very knowledgeable about celiac disease."
    },
    {
      id: 3,
      name: "Lisa K.",
      rating: 4,
      date: "3 weeks ago",
      comment: "Great atmosphere and delicious food. The gluten-free cupcakes were perfect!"
    }
  ];

  const menuHighlights = [
    { icon: "🍞", name: "Gluten-Free Artisan Bread" },
    { icon: "🥐", name: "Spanish Croissants (GF available)" },
    { icon: "🧁", name: "Gluten-Free Cupcakes" },
    { icon: "🍰", name: "Traditional Spanish Cakes (GF Version)" },
      ...
      <section className="py-8">
        <div className="container mx-auto px-4">
          <div className="flex items-center space-x-4 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Chok Sagasta Pastelería</h1>
              <p className="text-gray-600">Gluten-Free Pastry Shop in Madrid, Spain</p>
            </div>
          </div>
        </div>
      </section>
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <div className="flex items-center space-x-2 mb-2">
                    ...
                    <h4 className="text-xl font-bold text-gray-900">Chök Sagasta | Pastelería sin gluten</h4>
                  </div>
                  ...
                  <div className="space-y-2 text-sm text-gray-600">
                    <div className="flex items-center space-x-2">
                      ...
                      <span>Calle de Sagasta 15, Chamberí, Madrid, Spain</span>
                    </div>
                    <div className="flex items-center space-x-2">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-blue-600">www.choksagasta.es</span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <Phone className="h-4 w-4 text-green-600" />
                      <span className="text-green-600">+34 915 678 910</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-col items-end space-y-2 ml-4">
                  <Button 
                    ...
                    onClick={() => window.open('https://www.google.com/maps/search/?api=1&query=Calle+de+Sagasta+15%2C+Chamberí%2C+Madrid%2C+Spain', '_blank')}
                  >
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200">
            <div className="p-6 border-b border-gray-200">
              ...
              <p className="text-gray-700 leading-relaxed">
                Chök Sagasta in Madrid is a certified gluten-free pastry shop offering a full Spanish menu that's safe for celiacs. Known for its 
                gluten-free artisan breads, croissants, cupcakes, and traditional Spanish cakes, it has become a top choice for locals and travelers with 
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            ...
            <div className="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
              <div className="flex items-center space-x-2 text-blue-700">
                ...
                <span>Their artisan bread is celiac-safe</span>
              </div>
            </div>
          </div>
        </div>
...
export default ChokSagastaPasteleria;