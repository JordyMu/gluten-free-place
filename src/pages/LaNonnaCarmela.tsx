          ...
          <Card className="mb-8 overflow-hidden border-0 shadow-xl">
            <div className="relative">
              <img 
                ...
                alt="La Nonna Carmela"
                className="w-full h-64 object-cover"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent" />
              <div className="absolute bottom-6 left-6 text-white">
                <h1 className="text-3xl font-bold mb-2">🍝 La Nonna Carmela</h1>
                <div className="flex items-center space-x-4">
                  <div className="flex items-center">
                    ...
                    <span className="ml-1 text-sm opacity-90">(198 reviews)</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <CardContent className="p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm text-gray-600">
                <div className="flex items-center">
                  ...
                  <span>Via di San Cosimato 7/9, Madrid, Spain</span>
                </div>
                <div className="flex items-center">
                  <Clock className="h-4 w-4 mr-2 text-blue-500" />
                  <span>Mon-Sun: 1:00 PM - 11:30 PM</span>
                </div>
                <div className="flex items-center">
          ...
          <Card className="mb-8 border-0 shadow-lg">
            <CardContent className="p-6">
              ...
              <p className="text-gray-700 leading-relaxed">
                La Nonna Carmela in Madrid is a traditional Italian trattoria offering a full gluten-free menu that's safe for celiacs. Known for its 
                ...
                its celiac-safe certification. The restaurant uses traditional Italian recipes adapted for celiac requirements and their knowledgeable staff is extensively trained in gluten-free preparation.
              </p>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-6">
              ...
              <div className="space-y-3">
                <div className="flex items-center">
                  ...
                  <span className="font-medium">Gluten-Free Lasagna</span>
                </div>
                <div className="flex items-center">
                  <span className="text-lg mr-2">🍕</span>
            ...
            <CardContent className="p-6">
              ...
              <div className="space-y-6">
                <div className="border-b border-gray-100 pb-4">
                  ...
                  <p className="text-gray-700">Amazing authentic Italian food! As a celiac, I felt completely safe here. The gluten-free lasagna was incredible.</p>
                </div>
                ...
                <div className="border-b border-gray-100 pb-4">
                  ...
                  <p className="text-gray-700">Best gluten-free pizza in Madrid! Staff is very knowledgeable about celiac disease.</p>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-yellow-700">Their carbonara is celiac-safe</p>
                </div>
              </div>
            </CardContent>
          </Card>
