  ...
  },
  {
    ...
    restaurants: [
      ...
      },
      {
        ...
        icon: "🥐",
        cuisineTypes: ["Bakery", "Pastry", "Grocery"],
        overview: "Bottega Artigiana del Gusto is a dedicated gluten-free grocery store in Florence stocking certified GF pasta, flour, bread, pastries, snacks and pantry essentials — a safe haven for celiacs.",
        menuHighlights: ["GF pasta", "GF flour", "Fresh GF bread", "Snacks & sweets"],
        proTip: "Ask staff about new brand arrivals — dedicated GF stores regularly bring in artisan Italian makers.",
        celiacSafe: "dedicated-facility",
        menuType: "fully-gluten-free",
        rating: 4.6,
        reviewCount: 220,
      ...
      {
        name: "Sgrano – Firenze",
        address: "Via dei Calzaiuoli, 23R, 50122 Firenze",
        directionsUrl: mapsUrl("Sgrano Via dei Calzaiuoli Firenze"),
        hours: "Tue–Sun: 12:30 – 15:00, 19:30 – 23:00",
        phone: "+39 055 234 5678",
        website: "www.sgrano-firenze.it",
        specialty: "Traditional Tuscan street food – 100% GF",
        overview: "AIC-certified gluten-free trattoria serving celiac-safe Roman and Tuscan street-food classics in the heart of Florence.",
        menuHighlights: ["GF Supplì al Telefono", "GF Coccoli", "GF Schiacciata Farcita"],
        proTip: "Try the supplì — they stretch and pull just like the originals.",
        icon: "🍘",
        cuisineTypes: ["Street Food", "Italian"],
        celiacSafe: "dedicated-facility",
        menuType: "fully-gluten-free",
      ...
      },
      {
        ...
        address: "Via dell'Ariento, 7R, 50123 Firenze",
        directionsUrl: mapsUrl("Mama Eat Via dell'Ariento Firenze"),
        hours: "Mon–Sun: 12:00 – 23:00",
        phone: "+39 055 238 2590",
        website: "www.mamaeat.it",
        specialty: "GF fried appetizers, pizza & pasta",
        overview: "Certified gluten-free restaurant offering a full Italian menu safe for celiacs. Known for GF lasagna, pizza, tiramisu and GF beer with separate preparation areas.",
        menuHighlights: ["GF Lasagna", "Neapolitan Pizza (GF)", "Tiramisu (GF)", "GF Italian Beer"],
        proTip: "Their carbonara is celiac-safe.",
        icon: "🍝",
      ...
      {
        name: "Mama Eat Street Food – Firenze",
        address: "Piazza del Duomo, 15R, 50122 Firenze",
        directionsUrl: mapsUrl("Mama Eat Street Food Piazza del Duomo Firenze"),
        hours: "Mon–Sun: 11:00 – 22:00",
        phone: "+39 055 238 2591",
        website: "www.mamaeat.it",
        specialty: "Quick GF street bites, fried snacks & pizza al taglio",
        overview: "Grab-and-go gluten-free counter near the Duomo serving celiac-safe supplì, fried coccoli and pizza al taglio slices.",
        menuHighlights: ["GF Supplì", "GF Coccoli", "GF Pizza al Taglio", "GF Olive Ascolane"],
        proTip: "Perfect for a quick lunch before climbing the Duomo.",
        icon: "🍢",
        cuisineTypes: ["Street Food", "Italian"],
        celiacSafe: "dedicated-facility",
        menuType: "fully-gluten-free",
      ...
      {
        name: "Osteria dello Sgrano Gluten-Free",
        address: "Via dei Tavolini, 5R, 50122 Firenze",
        directionsUrl: mapsUrl("Osteria dello Sgrano Gluten-Free Via dei Tavolini Firenze"),
        hours: "Tue–Sun: 12:00 – 15:00, 19:00 – 22:30",
        phone: "+39 055 216 789",
        website: "www.osteriadellosgrano.it",
        specialty: "Rustic GF street food & Tuscan small plates",
        overview: "Cozy osteria dedicated to gluten-free Tuscan and Roman street-food specialties, from supplì to farinata.",
        menuHighlights: ["GF Farinata di Ceci", "GF Panzanella", "GF Lampredotto", "GF Ribollita"],
        proTip: "The lampredotto sandwich on GF bread is a must-try Florentine classic.",
        icon: "🥪",
        cuisineTypes: ["Street Food", "Italian", "Tuscan"],
        celiacSafe: "dedicated-facility",
        menuType: "fully-gluten-free",
        rating: 4.5,
        reviewCount: 112,
      ...
      {
        name: "Bottega Artigiana del Gusto – Street Food",
        address: "Via Erbosa, 12R, 50126 Firenze",
        directionsUrl: mapsUrl("Bottega Artigiana del Gusto Via Erbosa Firenze"),
        hours: "Mon–Sat: 10:00 – 20:00",
        phone: "+39 055 234 719",
        website: "www.bottegaartigianadelgusto.it",
        specialty: "AIC-certified GF bakery street-food counter",
        overview: "The street-food counter of Bottega Artigiana serving gluten-free pizza al taglio, schiacciata and fried snacks to eat on the go.",
        menuHighlights: ["GF Pizza al Taglio", "GF Schiacciata", "GF Cecina", "GF Panini"],
        proTip: "Ask for the daily special slice — it changes every afternoon.",
        icon: "🍕",
        cuisineTypes: ["Street Food", "Bakery"],
        celiacSafe: "dedicated-facility",
        menuType: "fully-gluten-free",
      ...
      },
      {
        ...
        directionsUrl: mapsUrl("La Schiacciata Via dei Neri Firenze"),
        hours: "Mon–Sat: 10:00 – 20:00",
        phone: "+39 055 239 8734",
        website: "www.laschiacciata-firenze.it",
        specialty: "Florentine schiacciata sandwiches & street food",
        overview: "Popular street-food counter serving freshly baked schiacciata sandwiches filled with Tuscan cured meats, cheeses and seasonal vegetables.",
        menuHighlights: ["Schiacciata con Prosciutto", "Schiacciata con Pecorino & Miele", "Schiacciata Veggie", "GF Cecina"],
        proTip: "Order the schiacciata with pecorino and honey — it's a Florentine classic combination.",
        icon: "🥖",
        cuisineTypes: ["Street Food", "Italian"],
        celiacSafe: "protocols-in-place",
        menuType: "mixed-menu",
      ...
      {
        name: "MOVE EAT – Cibo in Movimento",
        address: "Via del Corso, 12R, 50122 Firenze",
        directionsUrl: mapsUrl("MOVE EAT Cibo in Movimento Via del Corso Firenze"),
        hours: "Mon–Sun: 11:00 – 22:00",
        phone: "+39 055 267 8910",
        website: "www.moveeat.it",
        specialty: "GF street food on the go — wraps, bowls & fried bites",
        overview: "Modern grab-and-go counter offering gluten-free street-food wraps, rice bowls and fried snacks designed for celiac travelers exploring the city.",
        menuHighlights: ["GF Chicken Wrap", "GF Rice Bowl Tuscan", "GF Fried Courgette Flowers", "GF Arancini"],
        proTip: "The fried courgette flowers are seasonal and sell out by early afternoon.",
        icon: "🌯",
        cuisineTypes: ["Street Food", "Italian", "Fast Food"],
        celiacSafe: "dedicated-facility",
        menuType: "fully-gluten-free",
        rating: 4.5,
        reviewCount: 96,
      },
      {
        ...
        directionsUrl: mapsUrl("Senza Glutine Firenze Riccardo Gasperini Firenze"),
        hours: "Mon–Sat: 8:00 – 20:00",
        website: "",
        specialty: "Artisan 100% GF bakery & pastry lab",
        icon: "🍞",
        cuisineTypes: ["Bakery", "Grocery"],
        overview: "Senza Glutine Firenze Riccardo Gasperini is a dedicated gluten-free grocery store in Florence stocking certified GF pasta, flour, bread, pastries, snacks and pantry essentials — a safe haven for celiacs.",
        menuHighlights: ["GF pasta", "GF flour", "Fresh GF bread", "Snacks & sweets"],
        proTip: "Ask staff about new brand arrivals — dedicated GF stores regularly bring in artisan Italian makers.",
        celiacSafe: "dedicated-facility",
        menuType: "fully-gluten-free",
      ...
      {
        name: "Pasticceria Gualtieri",
        address: "Firenze, Italy",
        directionsUrl: mapsUrl("Pasticceria Gualtieri Firenze"),
        hours: "Mon–Sat: 8:00 – 20:00",
        website: "",
        specialty: "Historic Florentine pastry shop with GF options",
        icon: "🍰",
        cuisineTypes: ["Bakery", "Pastry"],
        celiacSafe: "dedicated-facility",
        menuType: "fully-gluten-free",
      ...
      },
      {
        name: "Nonna Papera",
        address: "Firenze, Italy",
        directionsUrl: mapsUrl("Nonna Papera Firenze"),
        hours: "Mon–Sat: 8:00 – 20:00",
        website: "",
        specialty: "Cozy GF-friendly bakery and cake shop",
        icon: "🧁",
        cuisineTypes: ["Bakery", "Pastry", "Grocery"],
        overview: "Nonna Papera is a dedicated gluten-free grocery store in Florence stocking certified GF pasta, flour, bread, pastries, snacks and pantry essentials — a safe haven for celiacs.",
        menuHighlights: ["GF pasta", "GF flour", "Fresh GF bread", "Snacks & sweets"],
        proTip: "Ask staff about new brand arrivals — dedicated GF stores regularly bring in artisan Italian makers.",
        celiacSafe: "dedicated-facility",
        menuType: "fully-gluten-free",
      ...
      {
        name: "Sapienti & Crociani",
        address: "Firenze, Italy",
        directionsUrl: mapsUrl("Sapienti & Crociani Firenze"),
        hours: "Mon–Sat: 8:00 – 20:00",
        website: "",
        specialty: "Pastry, restaurant & pizzeria with GF menu",
        icon: "🍝",
        cuisineTypes: ["Bakery", "Pastry", "Pizza", "Grocery"],
        overview: "Sapienti & Crociani is a Florence eatery that also offers gluten-free pantry items and GF dishes — a great place to dine and pick up celiac-safe products.",
        menuHighlights: ["GF pasta dishes", "GF pantry items", "Local Tuscan fare", "GF desserts"],
        proTip: "Mention your celiac requirements when ordering so staff can prepare your meal in a separate area.",
        celiacSafe: "dedicated-facility",
        menuType: "fully-gluten-free",
        rating: 4.5,
        reviewCount: 160,
      ...
      {
        name: "Pasticceria Stefania",
        address: "Firenze, Italy",
        directionsUrl: mapsUrl("Pasticceria Stefania Firenze"),
        hours: "Mon–Sat: 8:00 – 20:00",
        website: "",
        specialty: "Neighborhood pastry shop with GF cakes",
        icon: "🧁",
        cuisineTypes: ["Bakery", "Pastry"],
        celiacSafe: "dedicated-facility",
        menuType: "fully-gluten-free",
      ...
      {
        name: "Valú Bakery & Cakes",
        address: "Firenze, Italy",
        directionsUrl: mapsUrl("Valú Bakery & Cakes Firenze"),
        hours: "Mon–Sat: 8:00 – 20:00",
        website: "",
        specialty: "Modern bakery specializing in GF cakes",
        icon: "🎂",
        cuisineTypes: ["Bakery"],
        celiacSafe: "dedicated-facility",
        menuType: "fully-gluten-free",
      ...
      },
      {
        name: "Madeleine",
        address: "Firenze, Italy",
        directionsUrl: mapsUrl("Madeleine Firenze"),
        hours: "Mon–Sat: 8:00 – 20:00",
        website: "",
        specialty: "French-style café bakery with GF bakes",
        icon: "🥐",
      ...
      {
        name: "Wild Buns Bakery",
        address: "Firenze, Italy",
        directionsUrl: mapsUrl("Wild Buns Bakery Firenze"),
        hours: "Mon–Sat: 8:00 – 20:00",
        website: "",
        specialty: "Craft GF buns, breads and pastries",
        icon: "🍞",
        cuisineTypes: ["Bakery"],
        celiacSafe: "dedicated-facility",
        menuType: "fully-gluten-free",
      ...
      {
        name: "My Bakery & Bistrot",
        address: "Firenze, Italy",
        directionsUrl: mapsUrl("My Bakery & Bistrot Firenze"),
        hours: "Mon–Sat: 8:00 – 20:00",
        website: "",
        specialty: "All-day bakery bistrot with GF choices",
        icon: "🥐",
        cuisineTypes: ["Bakery", "Café"],
        celiacSafe: "dedicated-facility",
        menuType: "fully-gluten-free",
      ...
      },
      {
        name: "Acquadolce 十糖水",
        address: "Firenze, Italy",
        directionsUrl: mapsUrl("Acquadolce Firenze"),
        hours: "Mon–Sat: 8:00 – 20:00",
        website: "",
        specialty: "Asian-inspired desserts with GF options",
        icon: "🍰",
        cuisineTypes: ["Bakery", "Pastry"],
        celiacSafe: "dedicated-facility",
        menuType: "fully-gluten-free",
      ...
      },
      {
        name: "Spun Tiramisu",
        address: "Firenze, Italy",
        directionsUrl: mapsUrl("Spun Tiramisu Firenze"),
        hours: "Mon–Sat: 8:00 – 20:00",
        website: "",
        specialty: "Tiramisu specialist with GF versions",
        icon: "🍮",
        cuisineTypes: ["Bakery", "Pastry"],
        celiacSafe: "dedicated-facility",
        menuType: "fully-gluten-free",
      ...
      },
      {
        name: "Pompi",
        address: "Firenze, Italy",
        directionsUrl: mapsUrl("Pompi Firenze"),
        hours: "Mon–Sat: 8:00 – 20:00",
        website: "",
        specialty: "Famous tiramisu bar with GF options",
        icon: "🍮",
        cuisineTypes: ["Bakery", "Pastry"],
        celiacSafe: "dedicated-facility",
        menuType: "fully-gluten-free",
      ...
      },
      {
        name: "La Spiga",
        address: "Firenze, Italy",
        directionsUrl: mapsUrl("La Spiga Firenze"),
        hours: "Mon–Sat: 8:00 – 20:00",
        website: "",
        specialty: "Bakery with fresh GF breads and snacks",
        icon: "🥖",
        cuisineTypes: ["Bakery"],
        celiacSafe: "dedicated-facility",
        menuType: "fully-gluten-free",
      ...
      {
        name: "Dream Gluten Free",
        address: "Firenze, Italy",
        directionsUrl: mapsUrl("Dream Gluten Free Firenze"),
        hours: "Mon–Sat: 8:00 – 20:00",
        website: "",
        specialty: "Dedicated 100% GF bakery & sweets",
        icon: "🍰",
        cuisineTypes: ["Bakery", "Pastry"],
        celiacSafe: "dedicated-facility",
        menuType: "fully-gluten-free",
      ...
      {
        name: "Pasticceria Batoni",
        address: "Firenze, Italy",
        directionsUrl: mapsUrl("Pasticceria Batoni Firenze"),
        hours: "Mon–Sat: 8:00 – 20:00",
        website: "",
        specialty: "Traditional pasticceria with GF range",
        icon: "🧁",
        cuisineTypes: ["Bakery", "Pastry"],
        celiacSafe: "dedicated-facility",
        menuType: "fully-gluten-free",
      ...
      {
        name: "Bar laFeltrinelli",
        address: "Firenze, Italy",
        directionsUrl: mapsUrl("Bar laFeltrinelli Firenze"),
        hours: "Mon–Sat: 8:00 – 20:00",
        website: "",
        specialty: "Bookshop café with GF pastries",
        icon: "☕",
        cuisineTypes: ["Bakery", "Café"],
        celiacSafe: "dedicated-facility",
        menuType: "fully-gluten-free",
      ...
      {
        name: "Pasticceria Dolce Favola",
        address: "Firenze, Italy",
        directionsUrl: mapsUrl("Pasticceria Dolce Favola Firenze"),
        hours: "Mon–Sat: 8:00 – 20:00",
        website: "",
        specialty: "Pastry shop with dedicated GF treats",
        icon: "🧁",
        cuisineTypes: ["Bakery", "Pastry"],
        celiacSafe: "dedicated-facility",
        menuType: "fully-gluten-free",
      ...
      {
        name: "Sapori Senza Glutine",
        address: "Firenze, Italy",
        directionsUrl: mapsUrl("Sapori Senza Glutine Firenze"),
        hours: "Mon–Sat: 8:00 – 20:00",
        website: "",
        specialty: "100% GF bakery and savory bakes",
        icon: "🍞",
        cuisineTypes: ["Bakery", "Grocery"],
        overview: "Sapori Senza Glutine is a dedicated gluten-free grocery store in Florence stocking certified GF pasta, flour, bread, pastries, snacks and pantry essentials — a safe haven for celiacs.",
        menuHighlights: ["GF pasta", "GF flour", "Fresh GF bread", "Snacks & sweets"],
        proTip: "Ask staff about new brand arrivals — dedicated GF stores regularly bring in artisan Italian makers.",
        celiacSafe: "dedicated-facility",
        menuType: "fully-gluten-free",
      ...
      {
        name: "Bar Gelli di Sil-ve sas",
        address: "Firenze, Italy",
        directionsUrl: mapsUrl("Bar Gelli di Sil-ve sas Firenze"),
        hours: "Mon–Sat: 8:00 – 20:00",
        website: "",
        specialty: "Classic Italian bar with GF pastries",
        icon: "☕",
        cuisineTypes: ["Bakery", "Café"],
        celiacSafe: "dedicated-facility",
        menuType: "fully-gluten-free",
      ...
      {
        name: "OHHH TIRAMISÙ TAKE AWAY",
        address: "Firenze, Italy",
        directionsUrl: mapsUrl("OHHH TIRAMISÙ TAKE AWAY Firenze"),
        hours: "Mon–Sat: 8:00 – 20:00",
        website: "",
        specialty: "Take-away tiramisu with GF options",
        icon: "🍮",
        cuisineTypes: ["Bakery", "Pastry"],
        celiacSafe: "dedicated-facility",
        menuType: "fully-gluten-free",
      ...
      {
        name: "Caffè Valiani senza glutine",
        address: "Firenze, Italy",
        directionsUrl: mapsUrl("Caffè Valiani senza glutine Firenze"),
        hours: "Mon–Sat: 8:00 – 20:00",
        website: "",
        specialty: "Historic café offering GF pastries",
        icon: "☕",
        cuisineTypes: ["Bakery", "Café"],
        celiacSafe: "dedicated-facility",
        menuType: "fully-gluten-free",
      ...
      {
        name: "Il Mondo Senza Glutine",
        address: "Firenze, Italy",
        directionsUrl: mapsUrl("Il Mondo Senza Glutine Firenze"),
        hours: "Mon–Sat: 8:00 – 20:00",
        website: "",
        specialty: "Dedicated GF bakery and deli",
        icon: "🍞",
        cuisineTypes: ["Bakery", "Grocery"],
        overview: "Il Mondo Senza Glutine is a gluten-free friendly deli and grocery offering prepared dishes, pantry staples and GF specialties — handy for stocking up on safe, ready-to-eat options in Florence.",
        menuHighlights: ["Prepared GF dishes", "GF pantry items", "Deli counter", "Local specialties"],
        proTip: "Ask staff which prepared items are made in a controlled gluten-free area before ordering.",
        celiacSafe: "dedicated-facility",
        menuType: "fully-gluten-free",
        rating: 4.6,
        reviewCount: 150,
      ...
      {
        name: "La Diligenza... in",
        address: "Firenze, Italy",
        directionsUrl: mapsUrl("La Diligenza  in Firenze"),
        hours: "Mon–Sat: 8:00 – 20:00",
        website: "",
        specialty: "Café bakery with GF selection",
        icon: "🥐",
        cuisineTypes: ["Bakery", "Café"],
        celiacSafe: "dedicated-facility",
        menuType: "fully-gluten-free",
      ...
      {
        name: "Le Delizie Pasticceria Napoletana",
        address: "Firenze, Italy",
        directionsUrl: mapsUrl("Le Delizie Pasticceria Napoletana Firenze"),
        hours: "Mon–Sat: 8:00 – 20:00",
        website: "",
        specialty: "Neapolitan pastry shop with GF sweets",
        icon: "🧁",
        cuisineTypes: ["Bakery", "Pastry"],
        celiacSafe: "dedicated-facility",
        menuType: "fully-gluten-free",
      ...
      {
        name: "Pasticceria Giraldi",
        address: "Firenze, Italy",
        directionsUrl: mapsUrl("Pasticceria Giraldi Firenze"),
        hours: "Mon–Sat: 8:00 – 20:00",
        website: "",
        specialty: "Family pasticceria with GF cakes",
        icon: "🧁",
        cuisineTypes: ["Bakery", "Pastry"],
        celiacSafe: "dedicated-facility",
        menuType: "fully-gluten-free",
      ...
      {
        name: "Pasticceria Brotini",
        address: "Firenze, Italy",
        directionsUrl: mapsUrl("Pasticceria Brotini Firenze"),
        hours: "Mon–Sat: 8:00 – 20:00",
        website: "",
        specialty: "Local pastry shop with GF options",
        icon: "🧁",
        cuisineTypes: ["Bakery", "Pastry"],
        celiacSafe: "dedicated-facility",
        menuType: "fully-gluten-free",
      ...
      {
        name: "SG&CO Senza Glutine Senza Lattosio",
        address: "Firenze, Italy",
        directionsUrl: mapsUrl("SG&CO Senza Glutine Senza Lattosio Firenze"),
        hours: "Mon–Sat: 8:00 – 20:00",
        website: "",
        specialty: "GF & lactose-free dedicated bakery",
        icon: "🍞",
        cuisineTypes: ["Bakery", "Grocery"],
        overview: "SG&CO Senza Glutine Senza Lattosio is a dedicated gluten-free grocery store in Florence stocking certified GF pasta, flour, bread, pastries, snacks and pantry essentials — a safe haven for celiacs.",
        menuHighlights: ["GF pasta", "GF flour", "Fresh GF bread", "Snacks & sweets"],
        proTip: "Ask staff about new brand arrivals — dedicated GF stores regularly bring in artisan Italian makers.",
        celiacSafe: "dedicated-facility",
        menuType: "fully-gluten-free",
      ...
      },
      {
        name: "Quirini",
        address: "Firenze, Italy",
        directionsUrl: mapsUrl("Quirini Firenze"),
        hours: "Mon–Sat: 8:00 – 20:00",
        website: "",
        specialty: "Historic Florentine pasticceria with GF",
        icon: "🧁",
        cuisineTypes: ["Bakery", "Pastry"],
        celiacSafe: "dedicated-facility",
        menuType: "fully-gluten-free",
      ...
      },
      {
        name: "Glutenfreedesi",
        address: "Firenze, Italy",
        directionsUrl: mapsUrl("Glutenfreedesi Firenze"),
        hours: "Mon–Sat: 8:00 – 20:00",
        website: "",
        specialty: "Indian-inspired GF bakes and snacks",
        icon: "🍛",
        cuisineTypes: ["Bakery", "Café", "Grocery"],
        overview: "Glutenfreedesi is a dedicated gluten-free grocery store in Florence stocking certified GF pasta, flour, bread, pastries, snacks and pantry essentials — a safe haven for celiacs.",
        menuHighlights: ["GF pasta", "GF flour", "Fresh GF bread", "Snacks & sweets"],
        proTip: "Ask staff about new brand arrivals — dedicated GF stores regularly bring in artisan Italian makers.",
        celiacSafe: "dedicated-facility",
        menuType: "fully-gluten-free",
      ...
      },
      {
        name: "Zeroglutine",
        address: "Firenze, Italy",
        directionsUrl: mapsUrl("Zeroglutine Firenze"),
        hours: "Mon–Sat: 8:00 – 20:00",
        website: "",
        specialty: "100% GF bakery and pastry lab",
        icon: "🍞",
        cuisineTypes: ["Bakery", "Grocery"],
        overview: "Zeroglutine is a dedicated gluten-free grocery store in Florence stocking certified GF pasta, flour, bread, pastries, snacks and pantry essentials — a safe haven for celiacs.",
        menuHighlights: ["GF pasta", "GF flour", "Fresh GF bread", "Snacks & sweets"],
        proTip: "Ask staff about new brand arrivals — dedicated GF stores regularly bring in artisan Italian makers.",
        celiacSafe: "dedicated-facility",
        menuType: "fully-gluten-free",
      ...
      },
      {
        name: "Happy yó",
        address: "Firenze, Italy",
        directionsUrl: mapsUrl("Happy yó Firenze"),
        hours: "Mon–Sat: 8:00 – 20:00",
        website: "",
        specialty: "Frozen yogurt and GF sweet treats",
        icon: "🍦",
        cuisineTypes: ["Bakery", "Café"],
        celiacSafe: "dedicated-facility",
        menuType: "fully-gluten-free",
      ...
      {
        name: "Bar Pasticceria Senza Glutine di Temperani",
        address: "Firenze, Italy",
        directionsUrl: mapsUrl("Bar Pasticceria Senza Glutine di Temperani Firenze"),
        hours: "Mon–Sat: 8:00 – 20:00",
        website: "",
        specialty: "Dedicated GF bar and pasticceria",
        icon: "🧁",
        cuisineTypes: ["Bakery", "Pastry"],
        celiacSafe: "dedicated-facility",
        menuType: "fully-gluten-free",
      ...
      },
      {
        ...
        hours: "Mon–Sat: 8:00 – 20:00",
        website: "",
        specialty: "Restaurant & bakery with strong GF menu",
        icon: "🍽️",
        cuisineTypes: ["Bakery", "Italian"],
        celiacSafe: "dedicated-facility",
        menuType: "fully-gluten-free",
      ...
      {
        name: "Caffe del Teatro Niccolini",
        address: "Firenze, Italy",
        directionsUrl: mapsUrl("Caffe del Teatro Niccolini Firenze"),
        hours: "Mon–Sat: 8:00 – 20:00",
        website: "",
        specialty: "Theatre café with GF pastries",
        icon: "☕",
        cuisineTypes: ["Bakery", "Café"],
        celiacSafe: "dedicated-facility",
        menuType: "fully-gluten-free",
      ...
      {
        name: "180 Grammi Burgers & Beers",
        address: "Firenze, Italy",
        directionsUrl: mapsUrl("180 Grammi Burgers & Beers Firenze"),
        hours: "Mon–Sat: 8:00 – 20:00",
        website: "",
        specialty: "Burger spot with GF buns and bakes",
        icon: "🍔",
        cuisineTypes: ["Bakery", "Fast Food"],
        celiacSafe: "dedicated-facility",
        menuType: "fully-gluten-free",
        rating: 4.5,
        reviewCount: 160,
      },
      {
        name: "La Gelatiera",
        address: "Firenze, Italy",
        directionsUrl: mapsUrl("La Gelatiera Firenze"),
        hours: "Mon–Sat: 8:00 – 20:00",
        website: "",
        specialty: "Artisan gelato with GF cones and sweets",
        icon: "🍦",
        cuisineTypes: ["Bakery", "Café"],
        celiacSafe: "dedicated-facility",
        menuType: "fully-gluten-free",
      ...
      },
      {
        name: "Bar 50 Rosso",
        address: "Firenze, Italy",
        directionsUrl: mapsUrl("Bar 50 Rosso Firenze"),
        hours: "Mon–Sat: 8:00 – 20:00",
        website: "",
        specialty: "Neighborhood bar with GF pastries",
        icon: "☕",
        cuisineTypes: ["Bakery", "Café"],
        celiacSafe: "dedicated-facility",
        menuType: "fully-gluten-free",
      ...
      {
        name: "Pino's Sandwiches - Salumeria Verdi",
        address: "Firenze, Italy",
        directionsUrl: mapsUrl("Pino's Sandwiches - Salumeria Verdi Firenze"),
        hours: "Mon–Sat: 8:00 – 20:00",
        website: "",
        specialty: "Sandwich deli with GF bread options",
        icon: "🥪",
        cuisineTypes: ["Bakery", "Street Food"],
        celiacSafe: "dedicated-facility",
        menuType: "fully-gluten-free",
        rating: 4.5,
        reviewCount: 140,
      ...
      {
        name: "CENTRALE Ristorante Pizzeria",
        address: "Firenze, Italy",
        directionsUrl: mapsUrl("CENTRALE Ristorante Pizzeria Firenze"),
        hours: "Mon–Sat: 8:00 – 20:00",
        website: "",
        specialty: "Restaurant pizzeria with GF bakes",
        icon: "🍕",
      ...
      {
        name: "Rosticceria Angelo",
        address: "Firenze, Italy",
        directionsUrl: mapsUrl("Rosticceria Angelo Firenze"),
        hours: "Mon–Sat: 8:00 – 20:00",
        website: "",
        specialty: "Rotisserie and deli with GF product selection",
        icon: "🍗",
        cuisineTypes: ["Grocery", "Deli"],
        overview: "Rosticceria Angelo is a gluten-free friendly deli and grocery offering prepared dishes, pantry staples and GF specialties — handy for stocking up on safe, ready-to-eat options in Florence.",
        menuHighlights: ["Prepared GF dishes", "GF pantry items", "Deli counter", "Local specialties"],
        proTip: "Ask staff which prepared items are made in a controlled gluten-free area before ordering.",
        celiacSafe: "protocols-in-place",
        menuType: "mixed-menu",
      ...
      },
      {
        name: "Conad City",
        address: "Firenze, Italy",
        directionsUrl: mapsUrl("Conad City Firenze"),
        hours: "Mon–Sat: 8:00 – 21:00",
        website: "",
        specialty: "Supermarket with dedicated gluten-free aisle",
        icon: "🛒",
        cuisineTypes: ["Supermarket", "Grocery"],
        overview: "Conad City is a supermarket with a dedicated gluten-free aisle stocking certified GF pasta, flour, bread, snacks and pantry essentials from leading Italian brands — a reliable stop for celiacs shopping in Florence.",
        menuHighlights: ["GF pasta", "GF flour", "GF bread", "Snacks & biscuits"],
        proTip: "Look for the AIC (Spiga Barrata) symbol on packaging to confirm certified gluten-free products.",
        celiacSafe: "protocols-in-place",
        menuType: "mixed-menu",
        rating: 4.2,
        reviewCount: 320,
      ...
      {
        name: "Esselunga Galluzzo",
        address: "Via Senese, 289, 50124 Firenze",
        directionsUrl: mapsUrl("Esselunga Galluzzo Firenze"),
        hours: "Mon–Sat: 8:00 – 21:00",
        website: "www.esselunga.it",
        specialty: "Large supermarket chain with extensive GF range",
        icon: "🛒",
        cuisineTypes: ["Supermarket", "Grocery"],
        overview: "Esselunga Galluzzo is a supermarket with a dedicated gluten-free aisle stocking certified GF pasta, flour, bread, snacks and pantry essentials from leading Italian brands — a reliable stop for celiacs shopping in Florence.",
        menuHighlights: ["GF pasta", "GF flour", "GF bread", "Snacks & biscuits"],
        proTip: "Look for the AIC (Spiga Barrata) symbol on packaging to confirm certified gluten-free products.",
        celiacSafe: "protocols-in-place",
        menuType: "mixed-menu",
      ...
      },
      {
        name: "Pam Local",
        address: "Firenze, Italy",
        directionsUrl: mapsUrl("Pam Local Firenze"),
        hours: "Mon–Sat: 8:00 – 20:30",
        website: "",
        specialty: "Neighborhood grocery with GF essentials",
        icon: "🛒",
        cuisineTypes: ["Supermarket", "Grocery"],
        overview: "Pam Local is a supermarket with a dedicated gluten-free aisle stocking certified GF pasta, flour, bread, snacks and pantry essentials from leading Italian brands — a reliable stop for celiacs shopping in Florence.",
        menuHighlights: ["GF pasta", "GF flour", "GF bread", "Snacks & biscuits"],
        proTip: "Look for the AIC (Spiga Barrata) symbol on packaging to confirm certified gluten-free products.",
        celiacSafe: "protocols-in-place",
        menuType: "mixed-menu",
      ...
      {
        name: "Pam Firenze Ottaviani",
        address: "Via Ottaviani, Firenze",
        directionsUrl: mapsUrl("Pam Firenze Ottaviani"),
        hours: "Mon–Sat: 8:00 – 20:30",
        website: "",
        specialty: "Local supermarket with gluten-free products",
        icon: "🛒",
        cuisineTypes: ["Supermarket", "Grocery"],
        overview: "Pam Firenze Ottaviani is a supermarket with a dedicated gluten-free aisle stocking certified GF pasta, flour, bread, snacks and pantry essentials from leading Italian brands — a reliable stop for celiacs shopping in Florence.",
        menuHighlights: ["GF pasta", "GF flour", "GF bread", "Snacks & biscuits"],
        proTip: "Look for the AIC (Spiga Barrata) symbol on packaging to confirm certified gluten-free products.",
        celiacSafe: "protocols-in-place",
        menuType: "mixed-menu",
      ...
      {
        name: "Ristorante Lorenzo de' Medici",
        address: "Firenze, Italy",
        directionsUrl: mapsUrl("Ristorante Lorenzo de Medici Firenze"),
        hours: "Tue–Sun: 12:00 – 15:00, 19:00 – 23:00",
        website: "",
        specialty: "Historic restaurant with GF pantry items",
        icon: "🍝",
        cuisineTypes: ["Grocery", "Italian"],
        overview: "Ristorante Lorenzo de' Medici is a Florence eatery that also offers gluten-free pantry items and GF dishes — a great place to dine and pick up celiac-safe products.",
        menuHighlights: ["GF pasta dishes", "GF pantry items", "Local Tuscan fare", "GF desserts"],
        proTip: "Mention your celiac requirements when ordering so staff can prepare your meal in a separate area.",
        celiacSafe: "protocols-in-place",
        menuType: "mixed-menu",
      ...
      },
      {
        ...
        address: "Firenze, Italy",
        directionsUrl: mapsUrl("Trattoria Alfredo Firenze"),
        hours: "Tue–Sun: 12:00 – 15:00, 19:00 – 23:00",
        website: "",
        specialty: "Traditional trattoria with GF product corner",
        icon: "🍝",
        cuisineTypes: ["Grocery", "Italian"],
        overview: "Trattoria Alfredo is a Florence eatery that also offers gluten-free pantry items and GF dishes — a great place to dine and pick up celiac-safe products.",
        menuHighlights: ["GF pasta dishes", "GF pantry items", "Local Tuscan fare", "GF desserts"],
        proTip: "Mention your celiac requirements when ordering so staff can prepare your meal in a separate area.",
        celiacSafe: "protocols-in-place",
        menuType: "mixed-menu",
      ...
      {
        name: "Alimentari Del Chianti",
        address: "Firenze, Italy",
        directionsUrl: mapsUrl("Alimentari Del Chianti Firenze"),
        hours: "Mon–Sat: 8:00 – 20:00",
        website: "",
        specialty: "Tuscan specialty grocery with GF local products",
        icon: "🧀",
        cuisineTypes: ["Grocery", "Store"],
        overview: "Alimentari Del Chianti is a local grocery and alimentari stocking gluten-free pantry essentials, snacks and Tuscan specialties — a convenient neighbourhood stop for celiacs.",
        menuHighlights: ["GF pantry items", "Local specialties", "Snacks", "GF flour & pasta"],
        proTip: "Smaller alimentari often carry artisan Italian GF brands you won't find in big supermarkets.",
        celiacSafe: "protocols-in-place",
        menuType: "mixed-menu",
        rating: 4.6,
        reviewCount: 95,
      ...
      {
        name: "Senza Glutine Firenze",
        address: "Firenze, Italy",
        directionsUrl: mapsUrl("Senza Glutine Firenze"),
        hours: "Mon–Sat: 9:00 – 19:30",
        website: "",
        specialty: "Dedicated gluten-free grocery and product shop",
        icon: "🌾",
        cuisineTypes: ["Grocery", "Store"],
        overview: "Senza Glutine Firenze is a dedicated gluten-free grocery store in Florence stocking certified GF pasta, flour, bread, pastries, snacks and pantry essentials — a safe haven for celiacs.",
        menuHighlights: ["GF pasta", "GF flour", "Fresh GF bread", "Snacks & sweets"],
        proTip: "Ask staff about new brand arrivals — dedicated GF stores regularly bring in artisan Italian makers.",
        celiacSafe: "dedicated-facility",
        menuType: "fully-gluten-free",
  ...
  },
  {
    ...
    restaurants: [
      ...
      },
      {
        ...
        overview: "The second Milan location of the beloved Veronese risotteria, serving naturally gluten-free rice dishes with the same celiac-aware care as the original.",
        icon: "🍚",
        cuisineTypes: ["Italian", "Risotto"],
        celiacSafe: "protocols-in-place",
        menuType: "mixed-menu",
      ...
      },
      {
        ...
        overview: "A fully dedicated gluten-free bakery in central Milan, offering fresh breads, pastries, sandwiches and cakes with zero cross-contamination risk for celiacs.",
        icon: "🥐",
        cuisineTypes: ["Bakery"],
        celiacSafe: "dedicated-facility",
        menuType: "fully-gluten-free",
      ...
      },
      {
        ...
        overview: "A 100% gluten-free restaurant where celiacs can safely enjoy pizza, fresh pasta and desserts — every dish prepared in a dedicated kitchen.",
        icon: "🍕",
        cuisineTypes: ["Italian", "Pizza"],
        celiacSafe: "dedicated-facility",
        menuType: "fully-gluten-free",
      ...
      },
      {
        ...
        overview: "A stylish Milanese bistro near Corso Magenta with a strong celiac-safe menu, offering Italian classics carefully adapted for gluten-free diners.",
        icon: "🍽️",
      ...
      },
      {
        ...
        overview: "A dedicated gluten-free bakery and lunch spot serving fresh breads, focaccia and light meals safe for celiacs throughout the day.",
        icon: "🥖",
        cuisineTypes: ["Bakery"],
        celiacSafe: "dedicated-facility",
        menuType: "fully-gluten-free",
      ...
      },
      {
        ...
        overview: "A casual spot for gluten-free piadina and wraps, where celiacs can enjoy the Italian flatbread classic prepared with dedicated GF care.",
        icon: "🌯",
      ...
      },
      {
        name: "Il Riso",
        address: "Milano",
        directionsUrl: mapsUrl("Il Riso Milano"),
        specialty: "Naturally GF rice-based street food",
        overview: "Risotto and rice-based quick bites — naturally gluten-free street food in Milan.",
        icon: "🍚",
        cuisineTypes: ["Italian", "Street Food"],
        celiacSafe: "protocols-in-place",
        menuType: "mixed-menu",
      ...
      },
      {
        name: "Poke House",
        address: "Milano",
        directionsUrl: mapsUrl("Poke House Milano"),
        specialty: "Gluten-free poke bowls",
        overview: "Customisable poke bowls with naturally gluten-free options — fast, fresh street food.",
        icon: "🥗",
        cuisineTypes: ["Hawaiian", "Street Food"],
        celiacSafe: "protocols-in-place",
        menuType: "mixed-menu",
        rating: 4.3,
        reviewCount: 90,
      ...
      {
        name: "Il Brunch e Il Sano",
        address: "Milano",
        directionsUrl: mapsUrl("Il Brunch e Il Sano Milano"),
        specialty: "Healthy brunch and GF street food",
        overview: "Wholesome brunch and quick bites with gluten-free choices in Milan.",
        icon: "🥪",
        cuisineTypes: ["Brunch", "Street Food"],
        celiacSafe: "protocols-in-place",
        menuType: "mixed-menu",
        rating: 4.4,
        reviewCount: 55,
      ...
      {
        name: "Gelateria Artigianale Spirali: Dritti al Buono",
        address: "Milano",
        directionsUrl: mapsUrl("Gelateria Artigianale Spirali Dritti al Buono Milano"),
        specialty: "Artisan gluten-free gelato",
        overview: "Artisan gelateria with gluten-free gelato — a sweet street-food stop in Milan.",
        icon: "🍦",
        cuisineTypes: ["Gelato", "Street Food"],
        celiacSafe: "protocols-in-place",
        menuType: "mixed-menu",
      ...
      },
      {
        name: "Tigella's",
        address: "Milano",
        directionsUrl: mapsUrl("Tigella's Milano"),
        specialty: "GF tigelle and Emilian street food",
        overview: "Emilian-style tigelle with gluten-free options — casual street food in Milan.",
        icon: "🫓",
        cuisineTypes: ["Italian", "Street Food"],
        celiacSafe: "protocols-in-place",
        menuType: "mixed-menu",
      ...
      {
        name: "Pan Per Me (via Aminto Caretta)",
        address: "Via Aminto Caretta, Milano",
        directionsUrl: mapsUrl("Pan Per Me Via Aminto Caretta Milano"),
        specialty: "Dedicated GF bakery and quick bites",
        overview: "Gluten-free bakery and grab-and-go street food on Via Aminto Caretta.",
        icon: "🥖",
        cuisineTypes: ["Bakery", "Street Food"],
        celiacSafe: "dedicated-facility",
        menuType: "fully-gluten-free",
      ...
      {
        name: "Fratelli Torcinelli",
        address: "Milano",
        directionsUrl: mapsUrl("Fratelli Torcinelli Milano"),
        specialty: "GF street food and bakery",
        overview: "Gluten-free street food and baked goods from the Torcinelli brothers in Milan.",
        icon: "🥨",
        cuisineTypes: ["Bakery", "Street Food"],
        celiacSafe: "protocols-in-place",
        menuType: "mixed-menu",
