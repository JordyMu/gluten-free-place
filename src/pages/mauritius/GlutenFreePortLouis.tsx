...
useEffect(() => {
  ...
  const restaurants: Restaurant[] = portLouisRestaurants;
  ...
  const filteredRestaurants = useMemo(() => {
    let filtered = restaurants.filter(restaurant => {
      ...
      return matchesSafety && matchesCuisine && matchesMenu && matchesSearch;
    });
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
            <Link to="/gluten-free/mauritius/port-louis/street-food">
            ...
            <Link to="/gluten-free/mauritius/port-louis/bakeries">
            ...
            <Link to="/gluten-free/mauritius/port-louis/grocery-stores">
            ...
            <Link to="/gluten-free/mauritius/port-louis/gluten-free-products">
        ...
        <section className="mb-12">
          ...
          <div className="grid gap-6">
            {filteredRestaurants.map((restaurant, index) => (
              <Card key={index} className={`overflow-hidden border-2 border-red-200 ${restaurant.featured ? 'ring-2 ring-orange-300' : ''}`}>
                <CardContent className="p-6">
                      ...
                      <div className="flex items-start justify-between mb-3">
                        <div>
                          <div className="flex items-center gap-2 mb-1 flex-wrap">
                            ...
                            <Link to={`/gluten-free/mauritius/port-louis/${restaurant.slug}`} className="text-xl font-bold text-gray-900 hover:text-red-700 hover:underline transition-colors">{restaurant.name}</Link>
                          </div>
              ...
              <Card>
                ...
                <CardContent className="p-5 pt-0 space-y-2">
                  ...
                  {(menuFilters.length > 0 || cuisineFilters.length > 0 || safetyFilters.length > 0) && (
                    <button
                      type="button"
                      onClick={() => { setMenuFilters([]); setCuisineFilters([]); setSafetyFilters([]); }}
