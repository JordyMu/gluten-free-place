          ...
          <Card className="bg-gradient-to-r from-amber-50 to-orange-50 border-amber-200">
            <CardContent className="p-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h2 className="text-xl font-semibold text-gray-900 mb-1">Best Gluten-Free Restaurants in Grand Baie</h2>
                  <p className="text-gray-700">Our editorial top 10 celiac-safe picks across Grand Baie — ranked by safety, reviews and quality.</p>
                </div>
              </div>
              <Link to="/gluten-free/mauritius/grand-baie/best-gluten-free-restaurants-in-grand-baie" className="md:flex-shrink-0">
                  ...
                  <div className="flex flex-col lg:flex-row gap-6">
                    <div className="flex-1">
                      ...
                      <div className="flex gap-3">
                        ...
                        <Link to={`/gluten-free/mauritius/grand-baie/${restaurant.slug}`}>
