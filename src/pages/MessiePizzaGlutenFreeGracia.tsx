      ...
      <section className="py-8">
        <div className="container mx-auto px-4">
          <div className="flex items-center space-x-4 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Messie Pizza Gluten Free Gracia</h1>
              <p className="text-gray-600">Gluten-Free Pizzeria in Barcelona, Spain</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="pb-4">
        <div className="container mx-auto px-4">
          <div className="flex items-center space-x-2 mb-4">
            ...
            <h3 className="text-lg font-semibold">Barcelona (Gràcia)</h3>
          </div>
        </div>
      </section>
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <div className="flex items-center space-x-2 mb-2">
                    ...
                    <h4 className="text-xl font-bold text-gray-900">Messié Pizza Gluten Free Gràcia</h4>
                  </div>
                  ...
                  <div className="flex items-center space-x-4 mb-3">
                    <div className="flex items-center">
                      ...
                      <span className="text-sm text-gray-500 ml-1">(312 reviews)</span>
                    </div>
                  </div>

                  <div className="flex flex-wrap gap-2 mb-4">
                    <Badge className="bg-gray-100 text-gray-700 border-gray-300">Pizza</Badge>
                    <Badge className="bg-gray-100 text-gray-700 border-gray-300">Italian</Badge>
                  ...
                  <div className="space-y-2 text-sm text-gray-600">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-blue-600">www.messiepizza-gracia.com</span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <Phone className="h-4 w-4 text-green-600" />
                      <span className="text-green-600">+34 932 234 567</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-col items-end space-y-2 ml-4">
                  <Button 
                    ...
                    onClick={() => window.open('https://www.google.com/maps/search/?api=1&query=Carrer+de+Verdi+64,+Gràcia,+Barcelona,+Spain', '_blank')}
                  >
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            ...
            <div className="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
              <div className="flex items-center space-x-2 text-blue-700">
                ...
                <span>Try their signature Margherita - the gluten-free dough is made fresh daily and tastes just like traditional pizza!</span>
              </div>
            </div>
          </div>
        </div>
