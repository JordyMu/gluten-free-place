          ...
          <Card className="mb-8 overflow-hidden border-0 shadow-xl">
            <div className="relative">
              ...
              <div className="absolute bottom-6 left-6 text-white">
                <h1 className="text-3xl font-bold mb-2">🍜 ARUKU</h1>
                <div className="flex items-center space-x-4">
                  <div className="flex items-center">
                    ...
                    <span className="ml-1 text-sm opacity-90">(154 reviews)</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <Card className="mb-8 border-0 shadow-lg">
            <CardContent className="p-6">
              ...
              <p className="text-gray-700 leading-relaxed">
                ARUKU in Barcelona is a modern Asian fusion restaurant offering a full Asian menu that's safe for celiacs. Known for its 
                gluten-free ramen, sushi, pad thai, and even gluten-free beer, it has become a top choice for locals and travelers with 
                celiac disease. The restaurant provides separate preparation areas to avoid cross-contamination and proudly displays 
                its celiac-safe certification. The restaurant expertly adapts traditional Asian recipes for celiac requirements while maintaining authentic flavors from across Asia.
              </p>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-6">
              ...
              <div className="space-y-3">
                <div className="flex items-center">
                  ...
                  <span className="font-medium">Gluten-Free Ramen</span>
                </div>
                <div className="flex items-center">
                  <span className="text-lg mr-2">🍱</span>
                  <span className="font-medium">Sushi (GF available)</span>
                </div>
                <div className="flex items-center">
                  <span className="text-lg mr-2">🍝</span>
                  <span className="font-medium">Pad Thai (Gluten-Free Version)</span>
                </div>
                <div className="flex items-center">
                  <span className="text-lg mr-2">🍺</span>
                  <span className="font-medium">Gluten-Free Asian Beer</span>
                </div>
                <div className="flex items-center">
                  <span className="text-lg mr-2">🥗</span>
            ...
            <CardContent className="p-6">
              ...
              <div className="space-y-6">
                <div className="border-b border-gray-100 pb-4">
                  ...
                  <p className="text-gray-700">Amazing authentic Asian food! As a celiac, I felt completely safe here. The gluten-free ramen was incredible.</p>
                </div>
                ...
                <div className="border-b border-gray-100 pb-4">
                  ...
                  <p className="text-gray-700">Best gluten-free sushi in Barcelona! Staff is very knowledgeable about celiac disease.</p>
                </div>
                ...
                <div className="border-b border-gray-100 pb-4">
                  ...
                  <p className="text-gray-700">Great atmosphere and delicious food. The pad thai was perfect!</p>
                </div>
              </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-yellow-700">Their ramen is celiac-safe</p>
                </div>
              </div>
            </CardContent>
          </Card>
