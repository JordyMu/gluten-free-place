...
import { capeTownRestaurants, type Restaurant } from "@/data/capeTownRestaurants";
...
const CapeTownStreetFood = () => {
  const venues = capeTownRestaurants.filter((r) => r.venueType === "street-food");

  return (
    <>
      <SEOHead
        title="Gluten-Free Street Food in Cape Town | GlutenFreePlace"
        description="Discover gluten-free street food, food markets and quick bites across Cape Town. Safe celiac-friendly options on the go."
      ...
      <div className="min-h-screen bg-gradient-to-b from-orange-50 to-white">
        ...
        <section className="bg-gradient-to-r from-orange-600 to-red-600 text-white py-16">
          <div className="container mx-auto px-4 text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-4">Gluten-Free Street Food in Cape Town</h1>
            <p className="text-xl text-orange-100 max-w-2xl mx-auto">
              Discover gluten-free street food, food markets and quick bites across Cape Town. Safe celiac-friendly options on the go.
            </p>
            <div className="mt-6">
              <Badge className="bg-white/20 text-white text-lg px-4 py-2">
                {venues.length} Street Food Spots
              </Badge>
            </div>
          </div>
        </section>
        ...
        <main className="container mx-auto px-4 py-12">
          <div className="max-w-3xl mx-auto mb-8 bg-white border border-orange-200 rounded-lg p-6 flex flex-col sm:flex-row items-center justify-between gap-4 shadow-sm">
            <div>
              ...
              <p className="text-sm text-gray-600">Help the community — share your favorite 🍢 place in Cape Town.</p>
            </div>
            <AddRestaurantDialog
              city="cape-town"
            ...
            <Card className="text-center py-12 max-w-2xl mx-auto">
              <CardContent>
                ...
                <p className="text-gray-600 max-w-md mx-auto">
                  We're actively researching gluten-free street food options in Cape Town. Check back soon or suggest a venue!
                </p>
                <Link to="/gluten-free/south-africa/cape-town">
...
export default CapeTownStreetFood;
