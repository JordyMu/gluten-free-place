      ...
      <section className="pb-4">
        <div className="container mx-auto px-4">
          <div className="flex items-center space-x-2 mb-4">
            ...
            <h3 className="text-lg font-semibold">Seville (Sevilla)</h3>
          </div>
        </div>
      </section>
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <div className="flex items-center space-x-2 mb-2">
                    ...
                    <h4 className="text-xl font-bold text-gray-900">Cøliaki</h4>
                  </div>
                  ...
                  <div className="space-y-2 text-sm text-gray-600">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-blue-600">www.coliaki.es</span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <Phone className="h-4 w-4 text-green-600" />
                      <span className="text-green-600">+34 954 901 234</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-col items-end space-y-2 ml-4">
                  <Button 
                    ...
                    onClick={() => window.open('https://www.google.com/maps/search/?api=1&query=Calle+de+la+Constitución+15,+Seville,+Spain', '_blank')}
                  >
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            ...
            <div className="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
              <div className="flex items-center space-x-2 text-blue-700">
                ...
                <span>Their gluten-free croissants are baked fresh every morning - arrive early for the best selection!</span>
              </div>
            </div>
          </div>
        </div>
