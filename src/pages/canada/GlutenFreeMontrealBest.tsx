...
const pageTitle = "Best Gluten-Free Restaurants in Montreal (2026) | Top 10 Celiac-Safe Picks";
const description =
  "The 10 best gluten-free restaurants in Montreal for celiacs in 2026 — dedicated GF bakeries, cafés and restaurants ranked by safety, reviews and quality.";

const schemaJson = [
  {
    "@context": "https://schema.org",
    "@type": "ItemList",
    name: "Best Gluten-Free Restaurants in Montreal",
    description,
    url: "https://glutenfreeplace.org/gluten-free/canada/montreal/best-gluten-free-restaurants-in-montreal",
    itemListElement: top.map((r, i) => ({
      "@type": "ListItem",
      position: i + 1,
      name: r.name,
      url: `https://glutenfreeplace.org/gluten-free/canada/montreal/${r.slug}`,
    })),
  },
];

const GlutenFreeMontrealBest = () => (
  <>
    <SEOHead
      title={pageTitle}
      description={description}
      canonical="/gluten-free/canada/montreal/best-gluten-free-restaurants-in-montreal"
      schemaJson={schemaJson}
    />
    <div className="min-h-screen bg-gradient-to-br from-red-50 via-white to-red-50">
      <header className="bg-white shadow-sm border-b">
        <div className="container mx-auto px-4 py-4">
          <Link to="/gluten-free/canada/montreal" className="inline-flex items-center text-red-700 hover:text-red-800">
      ...
      <section className="relative text-white py-14 bg-gradient-to-r from-red-700 to-red-500">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <h1 className="text-3xl md:text-5xl font-bold mb-4">Best Gluten-Free Restaurants in Montreal</h1>
          <p className="text-lg md:text-xl text-white/90 max-w-3xl mx-auto">
            Our top 10 celiac-safe picks across Montreal — ranked by safety, reviews and quality (updated 2026).
          </p>
        </div>
      </section>
      ...
      <main className="container mx-auto px-4 py-8">
          ...
          <Card className="bg-gradient-to-r from-red-50 to-orange-50 border-red-200">
            <CardContent className="p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h2 className="text-xl font-semibold text-gray-900 mb-2">How we rank Montreal GF restaurants</h2>
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Top 10 Gluten-Free Restaurants in Montreal</h2>
              ...
              <Card key={r.slug} className="overflow-hidden">
                <CardContent className="p-6">
                  <div className="flex items-start gap-4 mb-3 flex-wrap">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-1 flex-wrap">
                        ...
                        <Link
                          to={`/gluten-free/canada/montreal/${r.slug}`}
                  ...
                  <div className="flex flex-wrap gap-3">
                    ...
                    <Link to={`/gluten-free/canada/montreal/${r.slug}`}>
        ...
        <section className="mb-12 text-center">
          <Link to="/gluten-free/canada/montreal" className="text-red-700 hover:text-red-800 font-medium">
            ← See all gluten-free restaurants in Montreal
          </Link>
        </section>
      </main>
    </div>
...
export default GlutenFreeMontrealBest;
