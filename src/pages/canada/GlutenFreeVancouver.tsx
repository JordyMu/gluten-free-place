        ...
        <CardContent className="p-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-gray-700">Our editorial top 10 celiac-safe picks across Vancouver — ranked by safety, reviews and quality.</p>
            </div>
          </div>
          <Link to="/gluten-free/canada/vancouver/best-gluten-free-restaurants-in-vancouver" className="md:flex-shrink-0">
...
const GlutenFreeVancouver = () => (
  <CanadaCityPage
    ...
    citySlug="vancouver"
    emoji="🏔️"
    heading="Dedicated Gluten-free Restaurants in Vancouver"
    heroImage="/images/vancouver-hero.webp?v=2"
