...
const GrossoNapoletanoSenzaGlutine = () => {
  return (
          ...
          <Card className="mb-8 overflow-hidden border-0 shadow-xl">
            <div className="relative">
              <img 
                ...
                alt="Grosso Napoletano Senza Glutine"
                className="w-full h-64 object-cover"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent" />
              <div className="absolute bottom-6 left-6 text-white">
                <h1 className="text-3xl font-bold mb-2">🍕 Grosso Napoletano Senza Glutine</h1>
                <div className="flex items-center space-x-4">
                  <div className="flex items-center">
                    ...
                    <span className="ml-1 text-sm opacity-90">(312 reviews)</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <Card className="mb-8 border-0 shadow-lg">
            <CardContent className="p-6">
              ...
              <p className="text-gray-700 leading-relaxed">
                Grosso Napoletano Senza Glutine in Barcelona is an authentic Neapolitan pizza restaurant offering a full gluten-free pizza menu that's safe for celiacs. Known for its 
                gluten-free Neapolitan pizza, traditional Italian toppings, and even gluten-free Italian beer, it has become a top choice for locals and travelers with 
                celiac disease. The restaurant provides separate preparation areas to avoid cross-contamination and proudly displays 
                its celiac-safe certification. The restaurant uses traditional Neapolitan techniques adapted for celiac requirements while maintaining authentic Italian flavors.
              </p>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-6">
              ...
              <div className="space-y-3">
                <div className="flex items-center">
                  ...
                  <span className="font-medium">Gluten-Free Neapolitan Pizza (GF available)</span>
                </div>
                <div className="flex items-center">
                  <span className="text-lg mr-2">🍝</span>
            ...
            <CardContent className="p-6">
              ...
              <div className="space-y-6">
                <div className="border-b border-gray-100 pb-4">
                  ...
                  <p className="text-gray-700">Amazing authentic Italian food! As a celiac, I felt completely safe here. The gluten-free pizza was incredible.</p>
                </div>
                ...
                <div className="border-b border-gray-100 pb-4">
                  ...
                  <p className="text-gray-700">Great atmosphere and delicious food. The tiramisu was perfect!</p>
                </div>
              </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-yellow-700">Their pizza is celiac-safe</p>
                </div>
              </div>
            </CardContent>
          </Card>
...
export default GrossoNapoletanoSenzaGlutine;