...
import { egyptTop25Restaurants } from "@/data/egyptRestaurants";

const menuTypeColors: Record<string, string> = {
  "fully-gluten-free": "bg-emerald-100 text-emerald-800 border-emerald-200",
...
export const EgyptRestaurantList = () => {
  return (
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-gray-900">
            Top 25 Gluten-Free Restaurants in Egypt
          </h2>
        ...
        <div className="max-w-3xl mx-auto space-y-5">
          {egyptTop25Restaurants.map((restaurant, index) => {
                ...
                <CardContent className="p-6">
                  <div className="mb-3">
                    <h3 className="text-xl font-bold text-gray-900 flex items-center gap-2">
                      ...
                      {citySlug ? (
                        <Link
                          to={`/gluten-free/egypt/${citySlug}/${restaurant.slug}`}
