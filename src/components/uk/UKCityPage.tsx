...
const UKCityPage = ({ cityName, citySlug, emoji, intro, restaurants, faqItems }: UKCityPageProps) => {
  ...
  useEffect(() => {
    ...
    const faqSchemaId = `uk-${citySlug}-faq`;
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-red-50">
      <header className="bg-white shadow-sm border-b">
        <div className="container mx-auto px-4 py-4">
          <Link to="/gluten-free/united-kingdom" className="inline-flex items-center text-blue-700 hover:text-blue-800">
      ...
      <section className="relative text-white py-14 bg-gradient-to-r from-blue-700 to-red-600">
