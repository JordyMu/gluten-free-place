...
const UKCityPage = ({ cityName, citySlug, emoji, intro, restaurants, faqItems }: UKCityPageProps) => {
  ...
  return (
    <>
    <SEOHead title={pageTitle} description={metaDescriptionText} canonical={`/gluten-free/united-kingdom/${citySlug}`} schemaJson={schemaJson} />
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-red-50">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <RelatedCities country="united-kingdom" currentCitySlug={citySlug} />
