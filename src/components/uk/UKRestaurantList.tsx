...
import { glasgowRestaurants, otherUKRestaurants } from "@/data/otherUKRestaurants";
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-gray-900">
            Top 25 Gluten-Free Restaurants in the UK
          </h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Our highest-rated gluten-free dining spots across Britain, verified for celiac safety
          </p>
        </div>
                ...
                <CardContent className="p-6">
                  <div className="mb-3">
                    <h3 className="text-xl font-bold text-gray-900 flex items-center gap-2">
                      ...
                      {citySlug ? (
                        <Link
                          to={`/gluten-free/united-kingdom/${citySlug}/${restaurant.slug}`}
