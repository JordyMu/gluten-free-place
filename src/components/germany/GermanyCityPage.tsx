...
interface GermanyCityPageProps {
  city: DECity;
  intro: string;
  emoji: string;
  faqItems: FAQItem[];
...
const getCeliacSafeBadge = (level: DERestaurant["celiacSafe"]) =>
...
const getMenuTypeBadge = (type: DERestaurant["menuType"]) =>
...
const GermanyCityPage = ({ city, intro, emoji, faqItems, heroImage, heroTitle }: GermanyCityPageProps) => {
  ...
  const pageTitle = `Gluten-Free Restaurants in ${city.name}, Germany | Celiac-Safe Dining`;
  const description = `Browse verified gluten-free restaurants, bakeries and cafés in ${city.name}, Germany, with celiac safety details, menu highlights and directions.`;
  const schemaJson = [
    {
      "@context": "https://schema.org",
      "@type": "CollectionPage",
      name: `Gluten-Free Restaurants in ${city.name}, Germany`,
      description,
      url: `https://glutenfreeplace.org/gluten-free/germany/${city.slug}`,
    },
    {
      "@context": "https://schema.org",
      "@type": "FAQPage",
      ...
      <div className="min-h-screen bg-gradient-to-br from-red-50 via-white to-red-50">
        <header className="bg-white shadow-sm border-b">
          <div className="container mx-auto px-4 py-4">
            <Link to="/germany" className="inline-flex items-center text-red-700 hover:text-red-800">
        ...
        >
          ...
          <div className="container mx-auto px-4 text-center relative z-10">
            ...
            <h1 className="text-3xl md:text-5xl font-bold mb-4">
              {heroTitle || `Dedicated gluten-free restaurants in ${city.name}`}
            </h1>
                  ...
                  <CardContent>
                    <div className="relative">
                      ...
                      <Input
                        ...
                        placeholder={`Search ${city.name} restaurants...`}
                        className="pl-9"
                      />
                    </div>
                  </CardContent>
...
export default GermanyCityPage;
