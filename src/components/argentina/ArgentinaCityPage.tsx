...
import type { ArgentinaRestaurant } from "@/data/argentinaRestaurants";
...
interface ArgentinaCityPageProps {
  cityName: string;
  restaurants: ArgentinaRestaurant[];
  intro: string;
  emoji: string;
  faqItems: FAQItem[];
  heroImage?: string;
...
const getCeliacSafeBadge = (level: ArgentinaRestaurant["celiacSafe"]) =>
...
const getMenuTypeBadge = (type: ArgentinaRestaurant["menuType"]) =>
...
const ArgentinaCityPage = ({ cityName, restaurants, intro, emoji, faqItems, heroImage, heroTitle }: ArgentinaCityPageProps) => {
  ...
  const pageTitle = `Gluten-Free Restaurants in ${cityName}, Argentina | Celiac-Safe Dining`;
  const description = `Browse verified gluten-free restaurants, bakeries and cafés in ${cityName}, Argentina, with celiac safety details and directions.`;
  const schemaJson = [
    {
      "@context": "https://schema.org",
      "@type": "CollectionPage",
      name: `Gluten-Free Restaurants in ${cityName}, Argentina`,
      description,
      url: `https://glutenfreeplace.org/gluten-free/argentina/${citySlug}`,
    },
    {
      "@context": "https://schema.org",
      "@type": "FAQPage",
  ...
  return (
    <>
      <SEOHead
        ...
        canonical={`/gluten-free/argentina/${citySlug}`}
      ...
      <div className="min-h-screen bg-gradient-to-br from-red-50 via-white to-red-50">
        <header className="bg-white shadow-sm border-b">
          <div className="container mx-auto px-4 py-4">
            <Link to="/argentina" className="inline-flex items-center text-red-700 hover:text-red-800">
        ...
        >
          ...
          <div className="container mx-auto px-4 text-center relative z-10">
            ...
            <h1 className="text-3xl md:text-5xl font-bold mb-4">
              {heroTitle || `Dedicated gluten-free restaurants in ${cityName}`}
            </h1>
            <p className="text-lg md:text-xl text-white/90 mb-6 max-w-3xl mx-auto">
              Verified celiac-safe spots, dedicated Sin TACC bakeries, and trusted dining picks in {cityName}.
            </p>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h2 className="text-xl font-semibold text-gray-900 mb-2">
                      Gluten-Free Dining in {cityName}
                    </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-[1fr_320px] gap-6">
              <div>
                <h2 className="text-2xl font-bold text-gray-900 mb-6">
                  Verified Gluten-Free Restaurants in {cityName}
                </h2>
              ...
              <aside className="md:sticky md:top-4 md:self-start order-first md:order-last space-y-4">
                  ...
                  <CardContent>
                    <div className="relative">
                      ...
                      <Input
                        ...
                        placeholder={`Search ${cityName} restaurants...`}
                        className="pl-9"
                      />
                    </div>
                  </CardContent>
                ...
                <Card>
                  ...
                  <CardContent className="p-5 pt-0 space-y-2">
                    ...
                    <p className="border-t pt-3 text-sm text-gray-600">Showing {filtered.length} of {restaurants.length}</p>
                  </CardContent>
                </Card>
              </aside>
            </div>
