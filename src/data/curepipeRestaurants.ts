...
export const curepipeRestaurants: MauritiusCityRestaurant[] = [
  {
    name: "The Yellow Chilli",
    slug: "the-yellow-chilli-curepipe",
  ...
  },
  {
    ...
    slug: "cafe-lux-riserva-curepipe",
    address: "Tribeca Mall, Trianon 72261, Mauritius",
    city: "Curepipe",
    country: "Mauritius",
  ...
  },
  {
    ...
    slug: "island-babe-healthy-food-curepipe",
...
export const getCurepipeRestaurantBySlug = (slug: string): MauritiusCityRestaurant | undefined => {
  return curepipeRestaurants.find(r => r.slug === slug);
};
