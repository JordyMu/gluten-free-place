...
export const montrealRestaurants: Restaurant[] = [
  ...
  },
  {
    ...
    venueType: "restaurant",
    photos: [
      { url: "/images/montreal/arepera-1.webp", caption: "Tequeños with Green Sauce" },
      { url: "/images/montreal/arepera-2.webp", caption: "Arepa Dominó with Black Beans & Cheese" },
      { url: "/images/montreal/arepera-3.webp", caption: "Arepa Pelúa with Shredded Beef & Fries" },
      { url: "/images/montreal/arepera-4.webp", caption: "Pabellón Criollo Platter" },
      { url: "/images/montreal/arepera-5.webp", caption: "Pabellón with Plantains & Rice" },
      { url: "/images/montreal/arepera-6.webp", caption: "Empanadas with Guasacaca" },
      { url: "/images/montreal/arepera-7.webp", caption: "Arepa Reina Pepiada with Avocado" },
      { url: "/images/montreal/arepera-8.webp", caption: "Quesillo (Venezuelan Flan)" },
    ],
    celiacSafetyScore: 9,
  },
  {
