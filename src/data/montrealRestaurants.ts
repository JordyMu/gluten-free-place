...
export const montrealRestaurants: Restaurant[] = [
  {
    ...
    photos: [
      { url: "/images/montreal/cantine-panella-1.webp", caption: "Beef Tartare with Crostini" },
      { url: "/images/montreal/cantine-panella-2.webp", caption: "GF Burger with Hand-Cut Fries" },
      { url: "/images/montreal/cantine-panella-3.webp", caption: "Baked Lasagna Gratin" },
      { url: "/images/montreal/cantine-panella-4.webp", caption: "Butternut Squash Velouté" },
      { url: "/images/montreal/cantine-panella-5.webp", caption: "GF Margherita Pizza" },
      { url: "/images/montreal/cantine-panella-6.webp", caption: "GF Baguette Sandwich with Salad" },
      { url: "/images/montreal/cantine-panella-7.webp", caption: "Carrot Cake with Walnut Crumble" },
      { url: "/images/montreal/cantine-panella-8.webp", caption: "Meatballs Pasta with Red Wine" },
    ],
    celiacSafetyScore: 8,
  },
  {
